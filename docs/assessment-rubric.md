...
66 sections. Jump to the one you need rather than reading this file end to end.

- [1. Purpose](#1-purpose)
- [2. Assessment Philosophy](#2-assessment-philosophy)
- [3. Candidate Intake Fields](#3-candidate-intake-fields)
- [4. Global 0-5 Skill Scale](#4-global-0-5-skill-scale)
- [5. Score Meaning by Interview Risk](#5-score-meaning-by-interview-risk)
- [6. Experience Bands](#6-experience-bands)
- [7. Experience-Level Expectations](#7-experience-level-expectations)
- [7.1 Beginner / Entry-Level Candidate](#71-beginner-entry-level-candidate)
- [7.2 Junior Data Engineer Candidate](#72-junior-data-engineer-candidate)
- [7.3 Mid-Level Data Engineer Candidate](#73-mid-level-data-engineer-candidate)
- [7.4 Experienced Data Engineer Candidate](#74-experienced-data-engineer-candidate)
- [7.5 Senior Data Engineer Candidate](#75-senior-data-engineer-candidate)
- [8. Readiness Verdicts](#8-readiness-verdicts)
- [9. Verdict Rules](#9-verdict-rules)
- [10. Module Weights](#10-module-weights)
- [11. SQL Rubric](#11-sql-rubric)
- [12. SQL Subskill Checklist](#12-sql-subskill-checklist)
- [13. Python Rubric](#13-python-rubric)
- [14. Python Subskill Checklist](#14-python-subskill-checklist)
- [15. DSA Rubric](#15-dsa-rubric)
- [16. DSA Subskill Checklist](#16-dsa-subskill-checklist)
- [17. Data Engineering Fundamentals Rubric](#17-data-engineering-fundamentals-rubric)
- [18. DE Fundamentals Subskill Checklist](#18-de-fundamentals-subskill-checklist)
- [19. Data Modeling Rubric](#19-data-modeling-rubric)
- [20. Data Modeling Subskill Checklist](#20-data-modeling-subskill-checklist)
- [21. ETL / ELT Pipeline Rubric](#21-etl-elt-pipeline-rubric)
- [22. Pipeline Subskill Checklist](#22-pipeline-subskill-checklist)
- [23. Spark / PySpark Rubric](#23-spark-pyspark-rubric)
- [24. Spark Subskill Checklist](#24-spark-subskill-checklist)
- [25. Data Warehousing Rubric](#25-data-warehousing-rubric)
- [26. Warehouse Subskill Checklist](#26-warehouse-subskill-checklist)
- [27. Cloud Data Platforms Rubric](#27-cloud-data-platforms-rubric)
- [28. Cloud Subskill Checklist](#28-cloud-subskill-checklist)
- [29. Airflow / Orchestration Rubric](#29-airflow-orchestration-rubric)
- [30. Orchestration Subskill Checklist](#30-orchestration-subskill-checklist)
- [31. Data Engineering System Design Rubric](#31-data-engineering-system-design-rubric)
- [32. System Design Subskill Checklist](#32-system-design-subskill-checklist)
- [33. Project Explanation Rubric](#33-project-explanation-rubric)
- [34. Project Explanation Subskill Checklist](#34-project-explanation-subskill-checklist)
- [35. Communication Rubric](#35-communication-rubric)
- [36. Communication Subskill Checklist](#36-communication-subskill-checklist)
- [37. Mock Interview Scoring Rubric](#37-mock-interview-scoring-rubric)
- [38. Final Interview Recommendation](#38-final-interview-recommendation)
- [39. Risk Flags](#39-risk-flags)
- [40. Improvement Priority Rules](#40-improvement-priority-rules)
- [41. Timeline Reality Check](#41-timeline-reality-check)
- [42. Weekly Study Hours Adjustment](#42-weekly-study-hours-adjustment)
- [43. Scoring Formula](#43-scoring-formula)
- [44. Override Rules](#44-override-rules)
- [45. Candidate Diagnosis Template](#45-candidate-diagnosis-template)
- [46. Module Assessment Template](#46-module-assessment-template)
- [47. SQL Assessment Drill Examples](#47-sql-assessment-drill-examples)
- [48. Python Assessment Drill Examples](#48-python-assessment-drill-examples)
- [49. DSA Assessment Drill Examples](#49-dsa-assessment-drill-examples)
- [50. System Design Assessment Drill Examples](#50-system-design-assessment-drill-examples)
- [51. Project Deep Dive Assessment Drill](#51-project-deep-dive-assessment-drill)
- [52. Strict Feedback Examples](#52-strict-feedback-examples)
- [53. Exit Criteria by Module](#53-exit-criteria-by-module)
- [54. Red / Yellow / Green Summary](#54-red-yellow-green-summary)
- [55. Roadmap Priority Mapping](#55-roadmap-priority-mapping)
- [56. Score Adjustment for Self-Rating Bias](#56-score-adjustment-for-self-rating-bias)
- [57. Handling Incomplete Assessments](#57-handling-incomplete-assessments)
- [58. Handling Unrealistic Goals](#58-handling-unrealistic-goals)
- [59. Handling Candidate Avoidance](#59-handling-candidate-avoidance)
- [60. Assessment Output Rules](#60-assessment-output-rules)
- [61. Final Assessment Principle](#61-final-assessment-principle)
<!-- END SECTION INDEX -->
