...
30 sections. Jump to the one you need rather than reading this file end to end.

- [1. Roadmap Philosophy](#1-roadmap-philosophy)
- [2. Roadmap Must Start After Assessment](#2-roadmap-must-start-after-assessment)
- [3. Default Priority Order](#3-default-priority-order)
- [4. Roadmap Output Template](#4-roadmap-output-template)
- [5. Timeline-Based Roadmaps](#5-timeline-based-roadmaps)
- [5.1 Emergency Roadmap: Less Than 2 Weeks](#51-emergency-roadmap-less-than-2-weeks)
- [5.2 One-Month Roadmap](#52-one-month-roadmap)
- [5.3 Three-Month Roadmap](#53-three-month-roadmap)
- [5.4 Six-Month Roadmap](#54-six-month-roadmap)
- [6. Module Roadmaps](#6-module-roadmaps)
- [6.1 SQL Roadmap](#61-sql-roadmap)
- [6.2 Python Roadmap](#62-python-roadmap)
- [6.3 DSA Roadmap](#63-dsa-roadmap)
- [6.4 Data Engineering Fundamentals Roadmap](#64-data-engineering-fundamentals-roadmap)
- [6.5 System Design Roadmap](#65-system-design-roadmap)
- [6.6 Project Deep Dive Roadmap](#66-project-deep-dive-roadmap)
- [7. Weekly Template](#7-weekly-template)
- [8. Daily Template](#8-daily-template)
- [9. Mock Interview Schedule](#9-mock-interview-schedule)
- [10. Exit Criteria for Interview Readiness](#10-exit-criteria-for-interview-readiness)
- [11. Roadmap Adjustment Rules](#11-roadmap-adjustment-rules)
- [12. Common Roadmap Mistakes](#12-common-roadmap-mistakes)
- [13. Weakness Repair Loop](#13-weakness-repair-loop)
- [14. Progress Tracking](#14-progress-tracking)
- [15. Roadmap Examples](#15-roadmap-examples)
- [15.1 Example: 1-Year Candidate, 3 Months](#151-example-1-year-candidate-3-months)
- [15.2 Example: 3-Year Candidate, 1 Month](#152-example-3-year-candidate-1-month)
- [15.3 Example: 5-Year Candidate, 6 Months](#153-example-5-year-candidate-6-months)
- [16. First 7-Day Plan Template](#16-first-7-day-plan-template)
- [17. Final Mentor Rule](#17-final-mentor-rule)
<!-- END SECTION INDEX -->
