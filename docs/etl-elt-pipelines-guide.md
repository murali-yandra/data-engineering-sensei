...
67 sections. Jump to the one you need rather than reading this file end to end.

- [1. What Is a Data Pipeline?](#1-what-is-a-data-pipeline)
- [2. Interview Standard](#2-interview-standard)
- [3. ETL vs ELT](#3-etl-vs-elt)
- [3.1 ETL](#31-etl)
- [3.2 ELT](#32-elt)
- [3.3 ETL vs ELT Comparison](#33-etl-vs-elt-comparison)
- [4. Pipeline Design Mindset](#4-pipeline-design-mindset)
- [5. Pipeline Architecture Layers](#5-pipeline-architecture-layers)
- [6. Source Systems](#6-source-systems)
- [7. Ingestion Patterns](#7-ingestion-patterns)
- [7.1 File-Based Ingestion](#71-file-based-ingestion)
- [7.2 Database Extraction](#72-database-extraction)
- [7.3 API Ingestion](#73-api-ingestion)
- [7.4 Streaming Ingestion](#74-streaming-ingestion)
- [8. Batch Pipelines](#8-batch-pipelines)
- [9. Streaming Pipelines](#9-streaming-pipelines)
- [10. Full Load](#10-full-load)
- [11. Incremental Load](#11-incremental-load)
- [12. Watermarks](#12-watermarks)
- [13. Lookback Windows](#13-lookback-windows)
- [14. Change Data Capture](#14-change-data-capture)
- [15. Pipeline Idempotency](#15-pipeline-idempotency)
- [16. Backfills](#16-backfills)
- [17. Reprocessing](#17-reprocessing)
- [18. Data Quality in ETL/ELT](#18-data-quality-in-etlelt)
- [19. Quality Checks by Layer](#19-quality-checks-by-layer)
- [20. Data Validation Failures](#20-data-validation-failures)
- [21. Schema Evolution](#21-schema-evolution)
- [22. Late-Arriving Data](#22-late-arriving-data)
- [23. Duplicate Data](#23-duplicate-data)
- [24. Deletes and Updates](#24-deletes-and-updates)
- [25. Pipeline Orchestration](#25-pipeline-orchestration)
- [26. Pipeline Monitoring](#26-pipeline-monitoring)
- [27. Alerts and SLAs](#27-alerts-and-slas)
- [28. Error Handling and Retry](#28-error-handling-and-retry)
- [29. Staging Tables](#29-staging-tables)
- [30. Audit Columns](#30-audit-columns)
- [31. Pipeline Metadata](#31-pipeline-metadata)
- [32. File Format Choices](#32-file-format-choices)
- [33. Partitioning Pipelines](#33-partitioning-pipelines)
- [34. Small Files Problem](#34-small-files-problem)
- [35. ETL/ELT and SQL Transformations](#35-etlelt-and-sql-transformations)
- [36. ETL/ELT and Python Transformations](#36-etlelt-and-python-transformations)
- [37. ETL/ELT and Spark Transformations](#37-etlelt-and-spark-transformations)
- [38. Pipeline Testing](#38-pipeline-testing)
- [39. Pipeline Deployment](#39-pipeline-deployment)
- [40. Security in Pipelines](#40-security-in-pipelines)
- [41. Pipeline Cost Awareness](#41-pipeline-cost-awareness)
- [42. Pipeline Documentation](#42-pipeline-documentation)
- [43. Common ETL/ELT Interview Questions](#43-common-etlelt-interview-questions)
- [44. Scenario: Daily Batch ETL Pipeline](#44-scenario-daily-batch-etl-pipeline)
- [45. Scenario: API ELT Pipeline](#45-scenario-api-elt-pipeline)
- [46. Scenario: Streaming Event Pipeline](#46-scenario-streaming-event-pipeline)
- [47. Scenario: CDC ELT Pipeline](#47-scenario-cdc-elt-pipeline)
- [48. Scenario: Backfill After Bad Transformation](#48-scenario-backfill-after-bad-transformation)
- [49. Weak vs Strong Answers](#49-weak-vs-strong-answers)
- [50. Common Interview Red Flags](#50-common-interview-red-flags)
- [51. Review Checklist](#51-review-checklist)
- [52. Scoring Rubric](#52-scoring-rubric)
- [53. Minimum Passing Standard](#53-minimum-passing-standard)
- [54. Strong Candidate Standard](#54-strong-candidate-standard)
- [55. 7-Day ETL/ELT Repair Plan](#55-7-day-etlelt-repair-plan)
- [56. 10-Minute Mock Interview](#56-10-minute-mock-interview)
- [57. Answer Template](#57-answer-template)
- [58. Mentor Behavior Rules](#58-mentor-behavior-rules)
- [59. Exit Test](#59-exit-test)
