...
- [3. SQL Readiness Levels](#3-sql-readiness-levels)
- [4. Core Rule: Define Grain First](#4-core-rule-define-grain-first)
- [5. SQL Answer Template](#5-sql-answer-template)
- [6. SQL Dialect Notes](#6-sql-dialect-notes)
- [7. SELECT Basics](#7-select-basics)
- [8. WHERE Filtering](#8-where-filtering)
- [9. NULL Handling](#9-null-handling)
- [10. COALESCE](#10-coalesce)
- [11. CASE Expressions](#11-case-expressions)
- [12. Aggregation Basics](#12-aggregation-basics)
- [13. COUNT Variants](#13-count-variants)
- [14. Conditional Aggregation](#14-conditional-aggregation)
- [15. HAVING](#15-having)
- [16. ORDER BY](#16-order-by)
- [17. LIMIT / TOP](#17-limit-top)
- [18. Joins Overview](#18-joins-overview)
- [19. INNER JOIN](#19-inner-join)
- [20. LEFT JOIN](#20-left-join)
- [21. FULL OUTER JOIN](#21-full-outer-join)
- [22. CROSS JOIN](#22-cross-join)
- [23. Anti Join](#23-anti-join)
- [24. Semi Join](#24-semi-join)
- [25. Join Grain and Duplicate Explosion](#25-join-grain-and-duplicate-explosion)
- [26. DISTINCT](#26-distinct)
- [27. CTEs](#27-ctes)
- [28. Subqueries](#28-subqueries)
- [29. Set Operations](#29-set-operations)
- [30. Window Functions Overview](#30-window-functions-overview)
- [31. ROW_NUMBER](#31-rownumber)
- [32. RANK and DENSE_RANK](#32-rank-and-denserank)
- [33. Top N Per Group](#33-top-n-per-group)
- [34. LAG and LEAD](#34-lag-and-lead)
- [35. Running Totals](#35-running-totals)
- [36. Moving Average](#36-moving-average)
- [37. Deduplication with Window Functions](#37-deduplication-with-window-functions)
- [38. Date Filtering](#38-date-filtering)
- [39. Event Time vs Ingestion Time](#39-event-time-vs-ingestion-time)
- [40. Timezone Awareness](#40-timezone-awareness)
- [41. Data Quality SQL](#41-data-quality-sql)
- [42. Reconciliation SQL](#42-reconciliation-sql)
- [43. Incremental Load SQL](#43-incremental-load-sql)
- [44. MERGE / UPSERT Concept](#44-merge-upsert-concept)
- [45. Delete and Reload Partition](#45-delete-and-reload-partition)
- [46. SCD Type 1 SQL](#46-scd-type-1-sql)
- [47. SCD Type 2 SQL Concept](#47-scd-type-2-sql-concept)
- [48. Fact and Dimension Query Awareness](#48-fact-and-dimension-query-awareness)
- [49. Output Grain in Fact Queries](#49-output-grain-in-fact-queries)
- [50. Latest Record Per Group](#50-latest-record-per-group)
- [51. Top K Per Group](#51-top-k-per-group)
- [52. Retention Query](#52-retention-query)
- [53. Funnel Query](#53-funnel-query)
- [54. Cohort Query](#54-cohort-query)
- [55. Gaps and Islands](#55-gaps-and-islands)
- [56. Sessions Query](#56-sessions-query)
- [57. Query Performance Basics](#57-query-performance-basics)
- [58. Indexes](#58-indexes)
- [59. Partitioning and Clustering](#59-partitioning-and-clustering)
- [60. Filter Early and Pre-Aggregate](#60-filter-early-and-pre-aggregate)
- [61. SQL Query Review Checklist](#61-sql-query-review-checklist)
- [62. Common SQL Mistakes](#62-common-sql-mistakes)
- [63. Basic SQL Drill Set](#63-basic-sql-drill-set)
- [64. Medium SQL Drill Set](#64-medium-sql-drill-set)
- [65. Advanced SQL Drill Set](#65-advanced-sql-drill-set)
- [66. SQL Mock Interview 1: Joins and Aggregation](#66-sql-mock-interview-1-joins-and-aggregation)
- [67. SQL Mock Interview 2: Deduplication](#67-sql-mock-interview-2-deduplication)
- [68. SQL Mock Interview 3: Retention](#68-sql-mock-interview-3-retention)
- [69. SQL Mock Interview 4: Funnel](#69-sql-mock-interview-4-funnel)
- [70. SQL Mock Interview 5: Reconciliation](#70-sql-mock-interview-5-reconciliation)
- [71. SQL Performance Mock](#71-sql-performance-mock)
- [72. SQL for Project Deep Dives](#72-sql-for-project-deep-dives)
- [73. SQL and Data Engineering System Design](#73-sql-and-data-engineering-system-design)
- [74. SQL Style Standards](#74-sql-style-standards)
- [75. Communication Standard for SQL](#75-communication-standard-for-sql)
- [76. SQL Feedback Templates](#76-sql-feedback-templates)
- [77. 7-Day SQL Repair Plan](#77-7-day-sql-repair-plan)
- [78. 30-Day SQL Plan](#78-30-day-sql-plan)
- [79. SQL LeetCode-Style Practice Map](#79-sql-leetcode-style-practice-map)
- [80. SQL Readiness Thresholds](#80-sql-readiness-thresholds)
- [81. Final SQL Exit Test](#81-final-sql-exit-test)
- [82. Final Summary](#82-final-summary)
- [83. Drill Appendix](#83-drill-appendix)
<!-- END SECTION INDEX -->
