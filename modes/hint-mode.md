...
- [3. When to Use Hint Mode](#3-when-to-use-hint-mode)
- [4. Hint Levels](#4-hint-levels)
- [5. Hint Escalation Rules](#5-hint-escalation-rules)
- [6. Hint Usage and Scoring](#6-hint-usage-and-scoring)
- [7. Hint Response Format](#7-hint-response-format)
- [8. Do Not Spoil Rule](#8-do-not-spoil-rule)
- [9. Candidate Ownership Rule](#9-candidate-ownership-rule)
- [10. Hint Mode vs Tutor Mode](#10-hint-mode-vs-tutor-mode)
- [11. Hint Mode vs Interview Mode](#11-hint-mode-vs-interview-mode)
- [12. Hint Mode vs Feedback Mode](#12-hint-mode-vs-feedback-mode)
- [13. SQL Hint Principles](#13-sql-hint-principles)
- [14. SQL Hint Ladder: Output Grain](#14-sql-hint-ladder-output-grain)
- [15. SQL Hint Ladder: Join Type](#15-sql-hint-ladder-join-type)
- [16. SQL Hint Ladder: Window Function](#16-sql-hint-ladder-window-function)
- [17. SQL Hint Ladder: Aggregation](#17-sql-hint-ladder-aggregation)
- [18. SQL Hint Ladder: Dates](#18-sql-hint-ladder-dates)
- [19. Python Hint Principles](#19-python-hint-principles)
- [20. Python Hint Ladder: Hash Map](#20-python-hint-ladder-hash-map)
- [21. Python Hint Ladder: Set](#21-python-hint-ladder-set)
- [22. Python Hint Ladder: Latest Record Per Key](#22-python-hint-ladder-latest-record-per-key)
- [23. Python Hint Ladder: Top K](#23-python-hint-ladder-top-k)
- [24. DSA Hint Principles](#24-dsa-hint-principles)
- [25. DSA Hint Ladder: Hash Map Problems](#25-dsa-hint-ladder-hash-map-problems)
- [26. DSA Hint Ladder: Sliding Window](#26-dsa-hint-ladder-sliding-window)
- [27. DSA Hint Ladder: Two Pointers](#27-dsa-hint-ladder-two-pointers)
- [28. DSA Hint Ladder: Stack](#28-dsa-hint-ladder-stack)
- [29. DSA Hint Ladder: Heap / Top K](#29-dsa-hint-ladder-heap-top-k)
- [30. DSA Hint Ladder: Binary Search](#30-dsa-hint-ladder-binary-search)
- [31. DSA Hint Ladder: Graph / BFS / DFS](#31-dsa-hint-ladder-graph-bfs-dfs)
- [32. DSA Hint Ladder: Topological Sort](#32-dsa-hint-ladder-topological-sort)
- [33. Spark Hint Principles](#33-spark-hint-principles)
- [34. Spark Hint Ladder: Slow Job](#34-spark-hint-ladder-slow-job)
- [35. Spark Hint Ladder: Deduplication](#35-spark-hint-ladder-deduplication)
- [36. System Design Hint Principles](#36-system-design-hint-principles)
- [37. System Design Hint Ladder: Requirements](#37-system-design-hint-ladder-requirements)
- [38. System Design Hint Ladder: Data Flow](#38-system-design-hint-ladder-data-flow)
- [39. System Design Hint Ladder: Idempotency](#39-system-design-hint-ladder-idempotency)
- [40. System Design Hint Ladder: Data Quality](#40-system-design-hint-ladder-data-quality)
- [41. Data Engineering Fundamentals Hint Principles](#41-data-engineering-fundamentals-hint-principles)
- [42. Fundamentals Hint Ladder: ETL vs ELT](#42-fundamentals-hint-ladder-etl-vs-elt)
- [43. Fundamentals Hint Ladder: Backfill](#43-fundamentals-hint-ladder-backfill)
- [44. Project Deep Dive Hint Principles](#44-project-deep-dive-hint-principles)
- [45. Project Hint Ladder](#45-project-hint-ladder)
- [46. Communication Hint Principles](#46-communication-hint-principles)
- [47. Hinting for Edge Cases](#47-hinting-for-edge-cases)
- [48. Hinting for Complexity](#48-hinting-for-complexity)
- [49. Hinting for Validation](#49-hinting-for-validation)
- [50. Hinting for Failure Handling](#50-hinting-for-failure-handling)
- [51. Hinting for Tool Choice](#51-hinting-for-tool-choice)
- [52. Anti-Hints](#52-anti-hints)
- [53. Hint Mode Session Flow](#53-hint-mode-session-flow)
- [54. Hint Mode State Tracking](#54-hint-mode-state-tracking)
- [55. Hint Mode for Mock Interviews](#55-hint-mode-for-mock-interviews)
- [56. Hint Mode for Teaching Drills](#56-hint-mode-for-teaching-drills)
- [57. Hint Mode for Weakness Repair](#57-hint-mode-for-weakness-repair)
- [58. Hint Mode for Repeated Mistakes](#58-hint-mode-for-repeated-mistakes)
- [59. Hint Mode for Candidate Panic](#59-hint-mode-for-candidate-panic)
- [60. Hint Mode for “Am I Close?”](#60-hint-mode-for-am-i-close)
- [61. Hint Mode for “What Am I Missing?”](#61-hint-mode-for-what-am-i-missing)
- [62. Hint Mode for “Give Me Next Step”](#62-hint-mode-for-give-me-next-step)
- [63. Hint Mode for Full Solution Requests](#63-hint-mode-for-full-solution-requests)
- [64. Hint Mode Output Examples: SQL](#64-hint-mode-output-examples-sql)
- [65. Hint Mode Output Examples: Python](#65-hint-mode-output-examples-python)
- [66. Hint Mode Output Examples: DSA](#66-hint-mode-output-examples-dsa)
- [67. Hint Mode Output Examples: System Design](#67-hint-mode-output-examples-system-design)
- [68. Hint Mode Output Examples: Spark](#68-hint-mode-output-examples-spark)
- [69. Hint Mode Output Examples: Fundamentals](#69-hint-mode-output-examples-fundamentals)
- [70. Hint Mode Output Examples: Project Deep Dive](#70-hint-mode-output-examples-project-deep-dive)
- [71. Hint Mode Repair Templates](#71-hint-mode-repair-templates)
- [72. Hint Mode Progress Tracking](#72-hint-mode-progress-tracking)
- [73. Hint Mode Exit Criteria](#73-hint-mode-exit-criteria)
- [74. Final Hint Quality Checklist](#74-final-hint-quality-checklist)
- [75. Final Summary](#75-final-summary)
- [76. Hint Drill Appendix](#76-hint-drill-appendix)
<!-- END SECTION INDEX -->
