...
70 sections. Jump to the one you need rather than reading this file end to end.

- [1. Mode Identity](#1-mode-identity)
- [2. Core Mission](#2-core-mission)
- [3. When to Use Pattern Mapper Mode](#3-when-to-use-pattern-mapper-mode)
- [4. First Response Behavior](#4-first-response-behavior)
- [5. Pattern Mapper Output Structure](#5-pattern-mapper-output-structure)
- [6. Pattern Classification Drill Format](#6-pattern-classification-drill-format)
- [7. Pattern Scoring Rubric](#7-pattern-scoring-rubric)
- [8. Pattern Recognition Rules](#8-pattern-recognition-rules)
- [9. Master Pattern Map](#9-master-pattern-map)
- [10. Cross-Domain Pattern Map](#10-cross-domain-pattern-map)
- [11. DSA Pattern: Hash Map](#11-dsa-pattern-hash-map)
- [12. DSA Pattern: Set](#12-dsa-pattern-set)
- [13. DSA Pattern: Two Pointers](#13-dsa-pattern-two-pointers)
- [14. DSA Pattern: Sliding Window](#14-dsa-pattern-sliding-window)
- [15. DSA Pattern: Prefix Sum](#15-dsa-pattern-prefix-sum)
- [16. DSA Pattern: Stack](#16-dsa-pattern-stack)
- [17. DSA Pattern: Heap / Top K](#17-dsa-pattern-heap-top-k)
- [18. DSA Pattern: Binary Search](#18-dsa-pattern-binary-search)
- [19. DSA Pattern: Intervals](#19-dsa-pattern-intervals)
- [20. DSA Pattern: Graph BFS/DFS](#20-dsa-pattern-graph-bfsdfs)
- [21. DSA Pattern: Topological Sort](#21-dsa-pattern-topological-sort)
- [22. DSA Pattern: Dynamic Programming](#22-dsa-pattern-dynamic-programming)
- [23. SQL Pattern: Output Grain First](#23-sql-pattern-output-grain-first)
- [24. SQL Pattern: GROUP BY Aggregation](#24-sql-pattern-group-by-aggregation)
- [25. SQL Pattern: Conditional Aggregation](#25-sql-pattern-conditional-aggregation)
- [26. SQL Pattern: JOIN Selection](#26-sql-pattern-join-selection)
- [27. SQL Pattern: Anti Join](#27-sql-pattern-anti-join)
- [28. SQL Pattern: Window Ranking](#28-sql-pattern-window-ranking)
- [29. SQL Pattern: Date Boundary](#29-sql-pattern-date-boundary)
- [30. SQL Pattern: Reconciliation](#30-sql-pattern-reconciliation)
- [31. Python Pattern: Dictionary Aggregation](#31-python-pattern-dictionary-aggregation)
- [32. Python Pattern: Set Membership](#32-python-pattern-set-membership)
- [33. Python Pattern: Latest Record Per Key](#33-python-pattern-latest-record-per-key)
- [34. Python Pattern: Top K](#34-python-pattern-top-k)
- [35. Spark Pattern: Wide Transformation / Shuffle](#35-spark-pattern-wide-transformation-shuffle)
- [36. Spark Pattern: Broadcast Join](#36-spark-pattern-broadcast-join)
- [37. Spark Pattern: Skew Handling](#37-spark-pattern-skew-handling)
- [38. Spark Pattern: File Layout](#38-spark-pattern-file-layout)
- [39. System Design Pattern: Batch Pipeline](#39-system-design-pattern-batch-pipeline)
- [40. System Design Pattern: Streaming Pipeline](#40-system-design-pattern-streaming-pipeline)
- [41. System Design Pattern: CDC Pipeline](#41-system-design-pattern-cdc-pipeline)
- [42. System Design Pattern: File Ingestion](#42-system-design-pattern-file-ingestion)
- [43. System Design Pattern: API Ingestion](#43-system-design-pattern-api-ingestion)
- [44. System Design Pattern: Quality Gate](#44-system-design-pattern-quality-gate)
- [45. System Design Pattern: Idempotent Write](#45-system-design-pattern-idempotent-write)
- [46. System Design Pattern: Backfill / Replay](#46-system-design-pattern-backfill-replay)
- [47. Data Modeling Pattern: Fact and Dimension](#47-data-modeling-pattern-fact-and-dimension)
- [48. Data Modeling Pattern: SCD Type 1 vs Type 2](#48-data-modeling-pattern-scd-type-1-vs-type-2)
- [49. Pattern Selection Decision Tree](#49-pattern-selection-decision-tree)
- [50. Wrong Pattern Correction Rules](#50-wrong-pattern-correction-rules)
- [51. Pattern Confusion Map](#51-pattern-confusion-map)
- [52. Pattern Drill: Classification Only](#52-pattern-drill-classification-only)
- [53. Pattern Drill: Cross-Domain Translation](#53-pattern-drill-cross-domain-translation)
- [54. Pattern Drill: Similar Problem Chain](#54-pattern-drill-similar-problem-chain)
- [55. Pattern Drill: Data Engineering Custom Problems](#55-pattern-drill-data-engineering-custom-problems)
- [56. Pattern Drill: SQL Pattern Bank](#56-pattern-drill-sql-pattern-bank)
- [57. Pattern Drill: DSA Pattern Bank](#57-pattern-drill-dsa-pattern-bank)
- [58. Pattern Drill: System Design Pattern Bank](#58-pattern-drill-system-design-pattern-bank)
- [59. Pattern Mapper Interview Behavior](#59-pattern-mapper-interview-behavior)
- [60. Pattern Mapper Feedback Template](#60-pattern-mapper-feedback-template)
- [61. Pattern Mapper Hint Strategy](#61-pattern-mapper-hint-strategy)
- [62. Pattern Mastery Levels](#62-pattern-mastery-levels)
- [63. 7-Day Pattern Repair Plan](#63-7-day-pattern-repair-plan)
- [64. 30-Day Pattern Mastery Plan](#64-30-day-pattern-mastery-plan)
- [65. Common Pattern Red Flags](#65-common-pattern-red-flags)
- [66. Strong Pattern Signals](#66-strong-pattern-signals)
- [67. Pattern Mapper Mode Exit Criteria](#67-pattern-mapper-mode-exit-criteria)
- [68. Final Pattern Mapper Test](#68-final-pattern-mapper-test)
- [69. Final Summary](#69-final-summary)
- [70. Pattern Drill Appendix](#70-pattern-drill-appendix)
<!-- END SECTION INDEX -->
