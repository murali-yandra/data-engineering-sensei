...
62 sections. Jump to the one you need rather than reading this file end to end.

- [1. Mode Identity](#1-mode-identity)
- [2. Core Mission](#2-core-mission)
- [3. Activation Trigger](#3-activation-trigger)
- [4. First Response Rule](#4-first-response-rule)
- [5. Required Assessment Questions](#5-required-assessment-questions)
- [6. Questions Not Required](#6-questions-not-required)
- [7. Optional Deep-Dive Questions](#7-optional-deep-dive-questions)
- [8. Assessment Output Structure](#8-assessment-output-structure)
- [9. Experience Calibration Rules](#9-experience-calibration-rules)
- [10. Role-Level Calibration](#10-role-level-calibration)
- [11. Module Score Interpretation](#11-module-score-interpretation)
- [12. Interview Readiness Percentage Rules](#12-interview-readiness-percentage-rules)
- [13. Readiness Caps](#13-readiness-caps)
- [14. SQL Assessment Rules](#14-sql-assessment-rules)
- [15. Python Assessment Rules](#15-python-assessment-rules)
- [16. DSA Assessment Rules](#16-dsa-assessment-rules)
- [17. Data Modeling Assessment Rules](#17-data-modeling-assessment-rules)
- [18. ETL/ELT Pipeline Assessment Rules](#18-etlelt-pipeline-assessment-rules)
- [19. Data Warehouse Assessment Rules](#19-data-warehouse-assessment-rules)
- [20. Spark/PySpark Assessment Rules](#20-sparkpyspark-assessment-rules)
- [21. Orchestration/Airflow Assessment Rules](#21-orchestrationairflow-assessment-rules)
- [22. Cloud Data Platform Assessment Rules](#22-cloud-data-platform-assessment-rules)
- [23. System Design Assessment Rules](#23-system-design-assessment-rules)
- [24. Project Deep Dive Assessment Rules](#24-project-deep-dive-assessment-rules)
- [25. Communication Assessment Rules](#25-communication-assessment-rules)
- [26. Strict Assessment Logic](#26-strict-assessment-logic)
- [27. Risk Classification](#27-risk-classification)
- [28. Priority Ranking Rules](#28-priority-ranking-rules)
- [29. Recommended Mode Selection](#29-recommended-mode-selection)
- [30. Assessment Report Template](#30-assessment-report-template)
- [31. Short Assessment Report Template](#31-short-assessment-report-template)
- [32. Assessment Example: 2-Year Data Engineer](#32-assessment-example-2-year-data-engineer)
- [33. Assessment Example: SQL Strong, System Design Weak](#33-assessment-example-sql-strong-system-design-weak)
- [34. Assessment Example: Strong Tools, Weak Communication](#34-assessment-example-strong-tools-weak-communication)
- [35. Assessment Example: Beginner Overall](#35-assessment-example-beginner-overall)
- [36. Assessment Example: Interview in 2 Weeks](#36-assessment-example-interview-in-2-weeks)
- [37. Assessment Example: No Target Companies](#37-assessment-example-no-target-companies)
- [38. Assessment Example: Current Tech Stack Not Provided](#38-assessment-example-current-tech-stack-not-provided)
- [39. Candidate Profile File Structure](#39-candidate-profile-file-structure)
- [40. Current State File Structure](#40-current-state-file-structure)
- [41. Next Steps File Structure](#41-next-steps-file-structure)
- [42. Roadmap Handoff Format](#42-roadmap-handoff-format)
- [43. Interview Mode Handoff Format](#43-interview-mode-handoff-format)
- [44. Weakness Repair Handoff Format](#44-weakness-repair-handoff-format)
- [45. Assessment Red Flags](#45-assessment-red-flags)
- [46. Assessment Strength Signals](#46-assessment-strength-signals)
- [47. No-Sugarcoating Assessment Language](#47-no-sugarcoating-assessment-language)
- [48. Assessment Follow-Up Validation](#48-assessment-follow-up-validation)
- [49. Quick Diagnostic Set](#49-quick-diagnostic-set)
- [50. Deep Diagnostic Set](#50-deep-diagnostic-set)
- [51. Assessment Report: Weakness Severity](#51-assessment-report-weakness-severity)
- [52. Assessment Report: Training Priority Matrix](#52-assessment-report-training-priority-matrix)
- [53. Assessment Report: Timeline Adjustment](#53-assessment-report-timeline-adjustment)
- [54. Assessment Report: Practice Time Adjustment](#54-assessment-report-practice-time-adjustment)
- [55. Assessment Report: Realistic Probability Language](#55-assessment-report-realistic-probability-language)
- [56. Profile Assessment Mode and Memory](#56-profile-assessment-mode-and-memory)
- [57. Assessment Mode Error Handling](#57-assessment-mode-error-handling)
- [58. Assessment Mode Anti-Patterns](#58-assessment-mode-anti-patterns)
- [59. Assessment Mode Strong Output Example](#59-assessment-mode-strong-output-example)
- [60. Assessment Mode Final Checklist](#60-assessment-mode-final-checklist)
- [61. Final Summary](#61-final-summary)
- [62. Assessment Drill Appendix](#62-assessment-drill-appendix)
<!-- END SECTION INDEX -->
