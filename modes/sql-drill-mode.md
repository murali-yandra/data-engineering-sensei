...
- [3. When to Use SQL Drill Mode](#3-when-to-use-sql-drill-mode)
- [4. First Response Behavior](#4-first-response-behavior)
- [5. SQL Expectations by Experience](#5-sql-expectations-by-experience)
- [6. SQL Drill Answer Framework](#6-sql-drill-answer-framework)
- [7. SQL Scoring Rubric](#7-sql-scoring-rubric)
- [8. Core SQL Interview Topics](#8-core-sql-interview-topics)
- [9. SQL Priority Order](#9-sql-priority-order)
- [10. SQL Dialect Rules](#10-sql-dialect-rules)
- [11. Hint Policy](#11-hint-policy)
- [12. SQL Review Template](#12-sql-review-template)
- [13. Common SQL Red Flags](#13-common-sql-red-flags)
- [14. Strong SQL Signals](#14-strong-sql-signals)
- [15. Pattern: Output Grain First](#15-pattern-output-grain-first)
- [16. Drill: Output Grain Classification](#16-drill-output-grain-classification)
- [17. Pattern: GROUP BY Aggregation](#17-pattern-group-by-aggregation)
- [18. Drill: Revenue Per Customer](#18-drill-revenue-per-customer)
- [19. Pattern: Conditional Aggregation](#19-pattern-conditional-aggregation)
- [20. Drill: Order Status Metrics](#20-drill-order-status-metrics)
- [21. Pattern: LEFT JOIN for Zero Rows](#21-pattern-left-join-for-zero-rows)
- [22. Drill: January Revenue Including Zero](#22-drill-january-revenue-including-zero)
- [23. Pattern: Anti Join](#23-pattern-anti-join)
- [24. Drill: Orders Missing Payments](#24-drill-orders-missing-payments)
- [25. Pattern: JOIN Cardinality and Duplicate Explosion](#25-pattern-join-cardinality-and-duplicate-explosion)
- [26. Drill: Avoid Duplicate Revenue](#26-drill-avoid-duplicate-revenue)
- [27. Pattern: ROW_NUMBER Latest Record](#27-pattern-rownumber-latest-record)
- [28. Drill: Latest Order Per Customer](#28-drill-latest-order-per-customer)
- [29. Pattern: Top N Per Group](#29-pattern-top-n-per-group)
- [30. Drill: Top 3 Products Per Category](#30-drill-top-3-products-per-category)
- [31. Pattern: Deduplication with ROW_NUMBER](#31-pattern-deduplication-with-rownumber)
- [32. Drill: Deduplicate Transaction Staging](#32-drill-deduplicate-transaction-staging)
- [33. Pattern: Duplicate Detection](#33-pattern-duplicate-detection)
- [34. Drill: Duplicate Orders](#34-drill-duplicate-orders)
- [35. Pattern: NULL Handling](#35-pattern-null-handling)
- [36. Drill: NULL-Safe Revenue](#36-drill-null-safe-revenue)
- [37. Pattern: Date and Timestamp Filtering](#37-pattern-date-and-timestamp-filtering)
- [38. Drill: Daily Active Users](#38-drill-daily-active-users)
- [39. Pattern: COUNT DISTINCT](#39-pattern-count-distinct)
- [40. Drill: Monthly Active Users](#40-drill-monthly-active-users)
- [41. Pattern: HAVING vs WHERE](#41-pattern-having-vs-where)
- [42. Drill: Customers with At Least 3 Orders](#42-drill-customers-with-at-least-3-orders)
- [43. Pattern: Running Total](#43-pattern-running-total)
- [44. Drill: Cumulative Daily Revenue](#44-drill-cumulative-daily-revenue)
- [45. Pattern: Rolling Window Metric](#45-pattern-rolling-window-metric)
- [46. Drill: 7-Day Rolling Revenue](#46-drill-7-day-rolling-revenue)
- [47. Pattern: LAG / LEAD](#47-pattern-lag-lead)
- [48. Drill: Day-over-Day Revenue Change](#48-drill-day-over-day-revenue-change)
- [49. Pattern: Source-Target Reconciliation](#49-pattern-source-target-reconciliation)
- [50. Drill: Revenue Reconciliation by Date](#50-drill-revenue-reconciliation-by-date)
- [51. Pattern: Data Quality Checks](#51-pattern-data-quality-checks)
- [52. Drill: Transaction Quality Checks](#52-drill-transaction-quality-checks)
- [53. Pattern: SCD Type 2 Basics](#53-pattern-scd-type-2-basics)
- [54. Drill: Detect Changed Customers for SCD2](#54-drill-detect-changed-customers-for-scd2)
- [55. Pattern: Cohort Retention](#55-pattern-cohort-retention)
- [56. Drill: Week-1 Retention](#56-drill-week-1-retention)
- [57. Pattern: Funnel Query](#57-pattern-funnel-query)
- [58. Drill: Ordered Purchase Funnel](#58-drill-ordered-purchase-funnel)
- [59. Pattern: Sessionization](#59-pattern-sessionization)
- [60. Drill: 30-Minute Sessions](#60-drill-30-minute-sessions)
- [61. Pattern: Date Spine for Missing Dates](#61-pattern-date-spine-for-missing-dates)
- [62. Drill: Daily Revenue Including Zero Days](#62-drill-daily-revenue-including-zero-days)
- [63. Pattern: Semi Join / EXISTS](#63-pattern-semi-join-exists)
- [64. Drill: Customers Who Purchased](#64-drill-customers-who-purchased)
- [65. Pattern: UNION vs UNION ALL](#65-pattern-union-vs-union-all)
- [66. Drill: Combine Web and Mobile Events](#66-drill-combine-web-and-mobile-events)
- [67. Pattern: CTEs for Readability](#67-pattern-ctes-for-readability)
- [68. Drill: Refactor Query into CTEs](#68-drill-refactor-query-into-ctes)
- [69. Pattern: Query Performance Basics](#69-pattern-query-performance-basics)
- [70. Drill: Optimize Slow Revenue Query](#70-drill-optimize-slow-revenue-query)
- [71. SQL Communication Rules](#71-sql-communication-rules)
- [72. SQL Mock Interview Flow](#72-sql-mock-interview-flow)
- [73. Beginner SQL Question Bank](#73-beginner-sql-question-bank)
- [74. Intermediate SQL Question Bank](#74-intermediate-sql-question-bank)
- [75. Advanced SQL Question Bank](#75-advanced-sql-question-bank)
- [76. Data Engineering Custom Drill: File Load Audit](#76-data-engineering-custom-drill-file-load-audit)
- [77. Data Engineering Custom Drill: Incremental Load Validation](#77-data-engineering-custom-drill-incremental-load-validation)
- [78. Data Engineering Custom Drill: Target Older Than Source](#78-data-engineering-custom-drill-target-older-than-source)
- [79. Data Engineering Custom Drill: Data Freshness](#79-data-engineering-custom-drill-data-freshness)
- [80. Data Engineering Custom Drill: Partition Row Count Check](#80-data-engineering-custom-drill-partition-row-count-check)
- [81. Data Engineering Custom Drill: Late Arriving Data](#81-data-engineering-custom-drill-late-arriving-data)
- [82. Data Engineering Custom Drill: Merchant Normalization Quality](#82-data-engineering-custom-drill-merchant-normalization-quality)
- [83. Data Engineering Custom Drill: Account Reconciliation](#83-data-engineering-custom-drill-account-reconciliation)
- [84. SQL Server Notes](#84-sql-server-notes)
- [85. PostgreSQL Notes](#85-postgresql-notes)
- [86. BigQuery/Snowflake Notes](#86-bigquerysnowflake-notes)
- [87. SQL and Data Modeling Connection](#87-sql-and-data-modeling-connection)
- [88. Drill: Join Fact to SCD2 Dimension](#88-drill-join-fact-to-scd2-dimension)
- [89. SQL and Pipeline Reliability Connection](#89-sql-and-pipeline-reliability-connection)
- [90. SQL Drill Session Format](#90-sql-drill-session-format)
- [91. 7-Day SQL Repair Plan](#91-7-day-sql-repair-plan)
- [92. 30-Day SQL Roadmap](#92-30-day-sql-roadmap)
- [93. SQL Mock Set 1: Beginner](#93-sql-mock-set-1-beginner)
- [94. SQL Mock Set 2: Intermediate](#94-sql-mock-set-2-intermediate)
- [95. SQL Mock Set 3: Advanced](#95-sql-mock-set-3-advanced)
- [96. Final SQL Exit Test](#96-final-sql-exit-test)
- [97. Common Mistake Playbook](#97-common-mistake-playbook)
- [98. SQL Drill Progress Tracking](#98-sql-drill-progress-tracking)
- [99. Mode Exit Criteria](#99-mode-exit-criteria)
- [100. Final Summary](#100-final-summary)
- [101. SQL Drill Appendix](#101-sql-drill-appendix)
<!-- END SECTION INDEX -->
