...
95 sections. Jump to the one you need rather than reading this file end to end.

- [1. Mode Identity](#1-mode-identity)
- [2. Core Mission](#2-core-mission)
- [3. When to Use Tutor Mode](#3-when-to-use-tutor-mode)
- [4. Tutor Mode vs Other Modes](#4-tutor-mode-vs-other-modes)
- [5. First Response Behavior](#5-first-response-behavior)
- [6. Tutor Session Structure](#6-tutor-session-structure)
- [7. Teach-Ask-Check Loop](#7-teach-ask-check-loop)
- [8. Explanation Depth Levels](#8-explanation-depth-levels)
- [9. Teaching Style Rules](#9-teaching-style-rules)
- [10. Visual Teaching Rules](#10-visual-teaching-rules)
- [11. Interview Connection Rule](#11-interview-connection-rule)
- [12. Data Engineering Relevance Rule](#12-data-engineering-relevance-rule)
- [13. Adaptive Tutoring Rules](#13-adaptive-tutoring-rules)
- [14. Tutor Scoring Rubric](#14-tutor-scoring-rubric)
- [15. Tutor Feedback Template](#15-tutor-feedback-template)
- [16. No-Sugarcoating Tutoring](#16-no-sugarcoating-tutoring)
- [17. Error Handling in Tutoring](#17-error-handling-in-tutoring)
- [18. Tutor Progress Tracking](#18-tutor-progress-tracking)
- [19. When to Hand Off to Other Modes](#19-when-to-hand-off-to-other-modes)
- [20. SQL Tutoring Principles](#20-sql-tutoring-principles)
- [21. SQL Lesson Template](#21-sql-lesson-template)
- [22. SQL Lesson: Output Grain](#22-sql-lesson-output-grain)
- [23. SQL Lesson: LEFT JOIN Filters](#23-sql-lesson-left-join-filters)
- [24. Python Tutoring Principles](#24-python-tutoring-principles)
- [25. Python Lesson Template](#25-python-lesson-template)
- [26. Python Lesson: Dictionary Aggregation](#26-python-lesson-dictionary-aggregation)
- [27. Python Lesson: Set Deduplication](#27-python-lesson-set-deduplication)
- [28. DSA Tutoring Principles](#28-dsa-tutoring-principles)
- [29. DSA Lesson Template](#29-dsa-lesson-template)
- [30. DSA Lesson: Hash Map](#30-dsa-lesson-hash-map)
- [31. Data Engineering Fundamentals Tutoring Principles](#31-data-engineering-fundamentals-tutoring-principles)
- [32. Fundamentals Lesson Template](#32-fundamentals-lesson-template)
- [33. Fundamentals Lesson: Idempotency](#33-fundamentals-lesson-idempotency)
- [34. Fundamentals Lesson: Backfill](#34-fundamentals-lesson-backfill)
- [35. Data Modeling Tutoring Principles](#35-data-modeling-tutoring-principles)
- [36. Data Modeling Lesson Template](#36-data-modeling-lesson-template)
- [37. Data Modeling Lesson: Fact and Dimension](#37-data-modeling-lesson-fact-and-dimension)
- [38. Data Warehouse Tutoring Principles](#38-data-warehouse-tutoring-principles)
- [39. Spark/PySpark Tutoring Principles](#39-sparkpyspark-tutoring-principles)
- [40. Spark Lesson Template](#40-spark-lesson-template)
- [41. Spark Lesson: Shuffle](#41-spark-lesson-shuffle)
- [42. Airflow/Orchestration Tutoring Principles](#42-airfloworchestration-tutoring-principles)
- [43. Cloud Data Platform Tutoring Principles](#43-cloud-data-platform-tutoring-principles)
- [44. System Design Tutoring Principles](#44-system-design-tutoring-principles)
- [45. System Design Lesson Template](#45-system-design-lesson-template)
- [46. Project Explanation Tutoring Principles](#46-project-explanation-tutoring-principles)
- [47. Communication Tutoring Principles](#47-communication-tutoring-principles)
- [48. Teaching With Examples](#48-teaching-with-examples)
- [49. Teaching With Counterexamples](#49-teaching-with-counterexamples)
- [50. Teaching With Analogies](#50-teaching-with-analogies)
- [51. Tutor Mini-Drill Rules](#51-tutor-mini-drill-rules)
- [52. Tutor Retest Rules](#52-tutor-retest-rules)
- [53. Tutor Difficulty Scaling](#53-tutor-difficulty-scaling)
- [54. Tutor Misconception Library](#54-tutor-misconception-library)
- [55. Tutor Lesson: ETL vs ELT](#55-tutor-lesson-etl-vs-elt)
- [56. Tutor Lesson: Batch vs Streaming](#56-tutor-lesson-batch-vs-streaming)
- [57. Tutor Lesson: CDC](#57-tutor-lesson-cdc)
- [58. Tutor Lesson: Watermark](#58-tutor-lesson-watermark)
- [59. Tutor Lesson: Data Quality](#59-tutor-lesson-data-quality)
- [60. Tutor Lesson: Monitoring](#60-tutor-lesson-monitoring)
- [61. Tutor Lesson: Partitioning](#61-tutor-lesson-partitioning)
- [62. Tutor Lesson: Schema Evolution](#62-tutor-lesson-schema-evolution)
- [63. Tutor Lesson: Late Data](#63-tutor-lesson-late-data)
- [64. Tutor Lesson: Fact Table Grain](#64-tutor-lesson-fact-table-grain)
- [65. Tutor Lesson: Topological Sort and DAGs](#65-tutor-lesson-topological-sort-and-dags)
- [66. Tutor Lesson: Top K Pattern](#66-tutor-lesson-top-k-pattern)
- [67. Tutor Lesson: Latest Record Per Key](#67-tutor-lesson-latest-record-per-key)
- [68. Tutor Lesson: Reconciliation](#68-tutor-lesson-reconciliation)
- [69. Tutor Lesson: Project Deep Dive](#69-tutor-lesson-project-deep-dive)
- [70. Tutor Lesson: Interview Answer Structure](#70-tutor-lesson-interview-answer-structure)
- [71. Tutor Drill Bank: SQL](#71-tutor-drill-bank-sql)
- [72. Tutor Drill Bank: Python](#72-tutor-drill-bank-python)
- [73. Tutor Drill Bank: DSA](#73-tutor-drill-bank-dsa)
- [74. Tutor Drill Bank: Fundamentals](#74-tutor-drill-bank-fundamentals)
- [75. Tutor Drill Bank: Modeling/Warehouse](#75-tutor-drill-bank-modelingwarehouse)
- [76. Tutor Drill Bank: Spark](#76-tutor-drill-bank-spark)
- [77. Tutor Drill Bank: System Design](#77-tutor-drill-bank-system-design)
- [78. Tutor Drill Bank: Project](#78-tutor-drill-bank-project)
- [79. 7-Day Tutor Mode Foundation Plan](#79-7-day-tutor-mode-foundation-plan)
- [80. 30-Day Tutor Mode Plan](#80-30-day-tutor-mode-plan)
- [81. Tutor Mode for Last-Minute Preparation](#81-tutor-mode-for-last-minute-preparation)
- [82. Tutor Mode for Advanced Candidates](#82-tutor-mode-for-advanced-candidates)
- [83. Tutor Mode for Beginners](#83-tutor-mode-for-beginners)
- [84. Tutor Mode for 2-Year Data Engineers](#84-tutor-mode-for-2-year-data-engineers)
- [85. Tutor Mode and LeetCode](#85-tutor-mode-and-leetcode)
- [86. Tutor Mode and Strictness](#86-tutor-mode-and-strictness)
- [87. Tutor Mode Readiness Signals](#87-tutor-mode-readiness-signals)
- [88. Tutor Mode Common Follow-Ups](#88-tutor-mode-common-follow-ups)
- [89. Tutor Mode Output Examples](#89-tutor-mode-output-examples)
- [90. Tutor Mode Anti-Patterns](#90-tutor-mode-anti-patterns)
- [91. Tutor Mode Quality Checklist](#91-tutor-mode-quality-checklist)
- [92. Tutor Mode Exit Criteria](#92-tutor-mode-exit-criteria)
- [93. Final Summary](#93-final-summary)
- [94. Quick Lesson Library](#94-quick-lesson-library)
- [95. Tutor Drill Appendix](#95-tutor-drill-appendix)
<!-- END SECTION INDEX -->
