...
- [1. Purpose](#1-purpose)
- [2. Why Hash Maps Matter for Data Engineers](#2-why-hash-maps-matter-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. Hash Map vs Set vs Counter vs defaultdict](#4-hash-map-vs-set-vs-counter-vs-defaultdict)
...
- [11. Pattern: Fast Lookup / Complement Lookup](#11-pattern-fast-lookup-complement-lookup)
- [12. Problem: Two Sum](#12-problem-two-sum)
- [13. Problem: Two Sum All Pairs](#13-problem-two-sum-all-pairs)
- [14. Pattern: Set Membership](#14-pattern-set-membership)
- [15. Problem: Contains Duplicate](#15-problem-contains-duplicate)
- [16. Problem: Happy Number](#16-problem-happy-number)
- [17. Pattern: Frequency Counting](#17-pattern-frequency-counting)
- [18. Problem: Valid Anagram](#18-problem-valid-anagram)
- [19. Problem: Ransom Note](#19-problem-ransom-note)
- [20. Problem: First Unique Character in a String](#20-problem-first-unique-character-in-a-string)
- [21. Problem: Find All Duplicates by Count](#21-problem-find-all-duplicates-by-count)
- [22. Pattern: Grouping by Key](#22-pattern-grouping-by-key)
- [23. Problem: Group Anagrams](#23-problem-group-anagrams)
- [24. Data Engineering Custom Problem: Group Transactions by Account](#24-data-engineering-custom-problem-group-transactions-by-account)
- [25. Pattern: Aggregation by Key](#25-pattern-aggregation-by-key)
- [26. Data Engineering Custom Problem: Sum Amount by User](#26-data-engineering-custom-problem-sum-amount-by-user)
- [27. Data Engineering Custom Problem: Average Amount by Category](#27-data-engineering-custom-problem-average-amount-by-category)
- [28. Pattern: Index Mapping](#28-pattern-index-mapping)
- [29. Problem: First Occurrence and Last Occurrence](#29-problem-first-occurrence-and-last-occurrence)
- [30. Problem: Isomorphic Strings](#30-problem-isomorphic-strings)
- [31. Problem: Word Pattern](#31-problem-word-pattern)
- [32. Pattern: Latest Record by Key](#32-pattern-latest-record-by-key)
- [33. Data Engineering Custom Problem: Keep Latest Event Per ID](#33-data-engineering-custom-problem-keep-latest-event-per-id)
- [34. Data Engineering Custom Problem: Latest Transaction Status](#34-data-engineering-custom-problem-latest-transaction-status)
- [35. Pattern: Prefix Sum + Hash Map](#35-pattern-prefix-sum-hash-map)
- [36. Problem: Subarray Sum Equals K](#36-problem-subarray-sum-equals-k)
- [37. Problem: Continuous Subarray Sum](#37-problem-continuous-subarray-sum)
- [38. Problem: Contiguous Array](#38-problem-contiguous-array)
- [39. Pattern: Sliding Window + Frequency Map](#39-pattern-sliding-window-frequency-map)
- [40. Problem: Longest Substring Without Repeating Characters](#40-problem-longest-substring-without-repeating-characters)
- [41. Problem: Longest Substring with At Most K Distinct Characters](#41-problem-longest-substring-with-at-most-k-distinct-characters)
- [42. Problem: Fruit Into Baskets](#42-problem-fruit-into-baskets)
- [43. Problem: Minimum Window Substring](#43-problem-minimum-window-substring)
- [44. Pattern: Two-Map Comparison](#44-pattern-two-map-comparison)
- [45. Data Engineering Custom Problem: Source-Target Count Reconciliation](#45-data-engineering-custom-problem-source-target-count-reconciliation)
- [46. Data Engineering Custom Problem: Schema Comparison](#46-data-engineering-custom-problem-schema-comparison)
- [47. Pattern: In-Memory Join / Enrichment](#47-pattern-in-memory-join-enrichment)
- [48. Data Engineering Custom Problem: Enrich Orders with Customers](#48-data-engineering-custom-problem-enrich-orders-with-customers)
- [49. Pattern: Top K After Counting](#49-pattern-top-k-after-counting)
- [50. Problem: Top K Frequent Elements](#50-problem-top-k-frequent-elements)
- [51. Problem: Sort Characters By Frequency](#51-problem-sort-characters-by-frequency)
- [52. Data Engineering Custom Problem: Top Error Services](#52-data-engineering-custom-problem-top-error-services)
- [53. Pattern: First / Last / Earliest / Latest Occurrence](#53-pattern-first-last-earliest-latest-occurrence)
- [54. Problem: Longest Consecutive Sequence](#54-problem-longest-consecutive-sequence)
- [55. Problem: Longest Consecutive Processed Dates](#55-problem-longest-consecutive-processed-dates)
- [56. Pattern: State Machine by Key](#56-pattern-state-machine-by-key)
- [57. Data Engineering Custom Problem: Apply CDC Events](#57-data-engineering-custom-problem-apply-cdc-events)
- [58. Pattern: Duplicate Conflict Detection](#58-pattern-duplicate-conflict-detection)
- [59. Data Engineering Custom Problem: Duplicate Event Conflicts](#59-data-engineering-custom-problem-duplicate-event-conflicts)
- [60. Pattern: Bucket / Signature Grouping](#60-pattern-bucket-signature-grouping)
- [61. Data Engineering Custom Problem: Group Merchant Aliases](#61-data-engineering-custom-problem-group-merchant-aliases)
- [62. Pattern: Cache / LRU Basics](#62-pattern-cache-lru-basics)
- [63. Problem: LRU Cache](#63-problem-lru-cache)
- [64. Python Hash Map Tools](#64-python-hash-map-tools)
- [65. Python Gotchas](#65-python-gotchas)
- [66. Hashable Key Rules](#66-hashable-key-rules)
- [67. Hash Map Dry Run Style](#67-hash-map-dry-run-style)
- [68. Pattern Classification Drill](#68-pattern-classification-drill)
- [69. High-ROI LeetCode List](#69-high-roi-leetcode-list)
- [70. Practice Ladder](#70-practice-ladder)
- [71. 7-Day Hash Map Plan](#71-7-day-hash-map-plan)
- [72. 30-Day Hash Map Plan](#72-30-day-hash-map-plan)
- [73. Hash Map Mock Set 1: Beginner](#73-hash-map-mock-set-1-beginner)
- [74. Hash Map Mock Set 2: Core](#74-hash-map-mock-set-2-core)
- [75. Hash Map Mock Set 3: Data Engineering Flavor](#75-hash-map-mock-set-3-data-engineering-flavor)
- [76. Hash Map Mock Set 4: Strong Candidate](#76-hash-map-mock-set-4-strong-candidate)
- [77. Timed Drill Protocol](#77-timed-drill-protocol)
- [78. Review Checklist](#78-review-checklist)
- [79. Weakness Repair Map](#79-weakness-repair-map)
- [80. Communication Scripts](#80-communication-scripts)
- [81. Candidate Self-Review Questions](#81-candidate-self-review-questions)
- [82. Maintenance Drills](#82-maintenance-drills)
- [83. Progress Tracking Template](#83-progress-tracking-template)
- [84. Final Exit Test](#84-final-exit-test)
- [85. Final Summary](#85-final-summary)
- [86. Problem Card Appendix](#86-problem-card-appendix)
- [87. Data Engineering Custom Problem Card Appendix](#87-data-engineering-custom-problem-card-appendix)
- [88. Drill Appendix](#88-drill-appendix)
