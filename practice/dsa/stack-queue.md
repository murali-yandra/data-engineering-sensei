...
92 sections. Jump to the one you need rather than reading this file end to end.

- [1. Purpose](#1-purpose)
- [2. Why Stack and Queue Matter for Data Engineers](#2-why-stack-and-queue-matter-for-data-engineers)
- [3. Core Mental Model: Stack](#3-core-mental-model-stack)
- [4. Core Mental Model: Queue](#4-core-mental-model-queue)
- [5. Core Mental Model: Deque](#5-core-mental-model-deque)
- [6. Stack vs Queue vs Deque Decision Table](#6-stack-vs-queue-vs-deque-decision-table)
...
- [13. Python Stack and Queue Tools](#13-python-stack-and-queue-tools)
- [14. Pattern: Bracket Validation](#14-pattern-bracket-validation)
- [15. Problem: Valid Parentheses](#15-problem-valid-parentheses)
- [16. Data Engineering Custom Problem: Validate SQL Parentheses](#16-data-engineering-custom-problem-validate-sql-parentheses)
- [17. Pattern: Path Simplification](#17-pattern-path-simplification)
- [18. Problem: Simplify Path](#18-problem-simplify-path)
- [19. Data Engineering Custom Problem: Normalize Object Storage Path](#19-data-engineering-custom-problem-normalize-object-storage-path)
- [20. Pattern: Expression Evaluation](#20-pattern-expression-evaluation)
- [21. Problem: Evaluate Reverse Polish Notation](#21-problem-evaluate-reverse-polish-notation)
- [22. Data Engineering Custom Problem: Evaluate Metric Formula](#22-data-engineering-custom-problem-evaluate-metric-formula)
- [23. Pattern: Decode Nested String](#23-pattern-decode-nested-string)
- [24. Problem: Decode String](#24-problem-decode-string)
- [25. Pattern: Min Stack / Auxiliary Stack](#25-pattern-min-stack-auxiliary-stack)
- [26. Problem: Min Stack](#26-problem-min-stack)
- [27. Pattern: Collision Resolution with Stack](#27-pattern-collision-resolution-with-stack)
- [28. Problem: Asteroid Collision](#28-problem-asteroid-collision)
- [29. Data Engineering Custom Problem: Resolve File Operations](#29-data-engineering-custom-problem-resolve-file-operations)
- [30. Pattern: Monotonic Stack](#30-pattern-monotonic-stack)
- [31. Monotonic Stack Template: Next Greater](#31-monotonic-stack-template-next-greater)
- [32. Problem: Next Greater Element I](#32-problem-next-greater-element-i)
- [33. Problem: Next Greater Element II](#33-problem-next-greater-element-ii)
- [34. Problem: Daily Temperatures](#34-problem-daily-temperatures)
- [35. Data Engineering Custom Problem: Next Higher Latency](#35-data-engineering-custom-problem-next-higher-latency)
- [36. Pattern: Stock Span](#36-pattern-stock-span)
- [37. Problem: Online Stock Span](#37-problem-online-stock-span)
- [38. Pattern: Largest Rectangle / Next Smaller](#38-pattern-largest-rectangle-next-smaller)
- [39. Problem: Largest Rectangle in Histogram](#39-problem-largest-rectangle-in-histogram)
- [40. Pattern: Remove K Digits](#40-pattern-remove-k-digits)
- [41. Problem: Remove K Digits](#41-problem-remove-k-digits)
- [42. Pattern: Basic Queue Simulation](#42-pattern-basic-queue-simulation)
- [43. Problem: Number of Recent Calls](#43-problem-number-of-recent-calls)
- [44. Data Engineering Custom Problem: Recent Event Counter](#44-data-engineering-custom-problem-recent-event-counter)
- [45. Pattern: Moving Average Queue](#45-pattern-moving-average-queue)
- [46. Problem: Moving Average from Data Stream](#46-problem-moving-average-from-data-stream)
- [47. Data Engineering Custom Problem: Rolling Average Latency](#47-data-engineering-custom-problem-rolling-average-latency)
- [48. Pattern: Monotonic Queue](#48-pattern-monotonic-queue)
- [49. Problem: Sliding Window Maximum](#49-problem-sliding-window-maximum)
- [50. Data Engineering Custom Problem: Rolling Max Latency](#50-data-engineering-custom-problem-rolling-max-latency)
- [51. Pattern: Time-Based Monotonic Queue](#51-pattern-time-based-monotonic-queue)
- [52. Data Engineering Custom Problem: Max Error Count in Recent Window](#52-data-engineering-custom-problem-max-error-count-in-recent-window)
- [53. Pattern: Queue Using Stacks](#53-pattern-queue-using-stacks)
- [54. Problem: Implement Queue using Stacks](#54-problem-implement-queue-using-stacks)
- [55. Pattern: Stack Using Queues](#55-pattern-stack-using-queues)
- [56. Problem: Implement Stack using Queues](#56-problem-implement-stack-using-queues)
- [57. Pattern: Circular Queue](#57-pattern-circular-queue)
- [58. Problem: Design Circular Queue](#58-problem-design-circular-queue)
- [59. Data Engineering Custom Problem: Fixed-Size Event Buffer](#59-data-engineering-custom-problem-fixed-size-event-buffer)
- [60. Pattern: BFS Queue](#60-pattern-bfs-queue)
- [61. Data Engineering Custom Problem: Process Jobs FIFO](#61-data-engineering-custom-problem-process-jobs-fifo)
- [62. Pattern: Undo / Rollback Stack](#62-pattern-undo-rollback-stack)
- [63. Data Engineering Custom Problem: Pipeline Rollback Order](#63-data-engineering-custom-problem-pipeline-rollback-order)
- [64. Pattern: Browser History / Navigation Stack](#64-pattern-browser-history-navigation-stack)
- [65. Problem: Design Browser History](#65-problem-design-browser-history)
- [66. Pattern: Backspace / Edit Simulation](#66-pattern-backspace-edit-simulation)
- [67. Problem: Backspace String Compare](#67-problem-backspace-string-compare)
- [68. Pattern: Remove Adjacent Duplicates](#68-pattern-remove-adjacent-duplicates)
- [69. Problem: Remove All Adjacent Duplicates In String](#69-problem-remove-all-adjacent-duplicates-in-string)
- [70. Problem: Remove All Adjacent Duplicates in String II](#70-problem-remove-all-adjacent-duplicates-in-string-ii)
- [71. Pattern Classification Drill](#71-pattern-classification-drill)
- [72. High-ROI LeetCode List](#72-high-roi-leetcode-list)
- [73. Practice Ladder](#73-practice-ladder)
- [74. 7-Day Stack/Queue Plan](#74-7-day-stackqueue-plan)
- [75. 30-Day Stack/Queue Plan](#75-30-day-stackqueue-plan)
- [76. Mock Set 1: Beginner](#76-mock-set-1-beginner)
- [77. Mock Set 2: Core Medium](#77-mock-set-2-core-medium)
- [78. Mock Set 3: Data Engineering Flavor](#78-mock-set-3-data-engineering-flavor)
- [79. Mock Set 4: Strong Candidate](#79-mock-set-4-strong-candidate)
...
- [90. Data Engineering Custom Problem Card Appendix](#90-data-engineering-custom-problem-card-appendix)
