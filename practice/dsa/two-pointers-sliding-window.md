...
91 sections. Jump to the one you need rather than reading this file end to end.

- [1. Purpose](#1-purpose)
- [2. Why These Patterns Matter for Data Engineers](#2-why-these-patterns-matter-for-data-engineers)
- [3. Core Mental Model: Two Pointers](#3-core-mental-model-two-pointers)
- [4. Core Mental Model: Sliding Window](#4-core-mental-model-sliding-window)
- [5. Fixed-Size vs Variable-Size Window](#5-fixed-size-vs-variable-size-window)
- [6. Positive Numbers vs Negative Numbers Warning](#6-positive-numbers-vs-negative-numbers-warning)
- [7. Standard Answer Framework](#7-standard-answer-framework)
- [8. Scoring Rubric](#8-scoring-rubric)
- [9. Complexity Rules](#9-complexity-rules)
- [10. Edge Case Checklist](#10-edge-case-checklist)
- [11. Pattern Map](#11-pattern-map)
- [12. Common Mistakes](#12-common-mistakes)
- [13. Pattern: Opposite-Direction Two Pointers](#13-pattern-opposite-direction-two-pointers)
- [14. Problem: Two Sum II](#14-problem-two-sum-ii)
- [15. Data Engineering Custom Problem: Match Debit Credit Amounts](#15-data-engineering-custom-problem-match-debit-credit-amounts)
- [16. Pattern: Palindrome Two Pointers](#16-pattern-palindrome-two-pointers)
- [17. Problem: Valid Palindrome](#17-problem-valid-palindrome)
- [18. Problem: Valid Palindrome II](#18-problem-valid-palindrome-ii)
- [19. Pattern: Fast and Slow Pointers](#19-pattern-fast-and-slow-pointers)
- [20. Problem: Linked List Cycle](#20-problem-linked-list-cycle)
- [21. Problem: Middle of the Linked List](#21-problem-middle-of-the-linked-list)
- [22. Pattern: Read/Write Pointer for In-Place Compaction](#22-pattern-readwrite-pointer-for-in-place-compaction)
- [23. Problem: Remove Duplicates from Sorted Array](#23-problem-remove-duplicates-from-sorted-array)
- [24. Problem: Remove Element](#24-problem-remove-element)
- [25. Problem: Move Zeroes](#25-problem-move-zeroes)
- [26. Data Engineering Custom Problem: Compact Valid Records](#26-data-engineering-custom-problem-compact-valid-records)
- [27. Pattern: Two Sorted Lists Comparison](#27-pattern-two-sorted-lists-comparison)
- [28. Problem: Intersection of Two Arrays II Sorted Variant](#28-problem-intersection-of-two-arrays-ii-sorted-variant)
- [29. Data Engineering Custom Problem: Reconcile Sorted IDs](#29-data-engineering-custom-problem-reconcile-sorted-ids)
- [30. Pattern: 3Sum / K-Sum After Sorting](#30-pattern-3sum-k-sum-after-sorting)
- [31. Problem: 3Sum](#31-problem-3sum)
- [32. Problem: 3Sum Closest](#32-problem-3sum-closest)
- [33. Pattern: Container / Max Area](#33-pattern-container-max-area)
- [34. Problem: Container With Most Water](#34-problem-container-with-most-water)
- [35. Pattern: Trapping Rain Water](#35-pattern-trapping-rain-water)
- [36. Problem: Trapping Rain Water](#36-problem-trapping-rain-water)
- [37. Pattern: Fixed-Size Sliding Window](#37-pattern-fixed-size-sliding-window)
- [38. Problem: Maximum Average Subarray I](#38-problem-maximum-average-subarray-i)
- [39. Data Engineering Custom Problem: Rolling K-Run Error Sum](#39-data-engineering-custom-problem-rolling-k-run-error-sum)
- [40. Pattern: Fixed Window with Frequency Map](#40-pattern-fixed-window-with-frequency-map)
- [41. Problem: Permutation in String](#41-problem-permutation-in-string)
- [42. Problem: Find All Anagrams in a String](#42-problem-find-all-anagrams-in-a-string)
- [43. Pattern: Variable Window - Longest Valid Window](#43-pattern-variable-window---longest-valid-window)
- [44. Problem: Longest Substring Without Repeating Characters](#44-problem-longest-substring-without-repeating-characters)
- [45. Problem: Longest Substring with At Most K Distinct Characters](#45-problem-longest-substring-with-at-most-k-distinct-characters)
- [46. Problem: Fruit Into Baskets](#46-problem-fruit-into-baskets)
- [47. Data Engineering Custom Problem: Longest Session with K Event Types](#47-data-engineering-custom-problem-longest-session-with-k-event-types)
- [48. Pattern: Variable Window - Shortest Valid Window](#48-pattern-variable-window---shortest-valid-window)
- [49. Problem: Minimum Size Subarray Sum](#49-problem-minimum-size-subarray-sum)
- [50. Data Engineering Custom Problem: Shortest Error Window](#50-data-engineering-custom-problem-shortest-error-window)
- [51. Problem: Minimum Window Substring](#51-problem-minimum-window-substring)
- [52. Data Engineering Custom Problem: Smallest Log Segment with Required Events](#52-data-engineering-custom-problem-smallest-log-segment-with-required-events)
- [53. Pattern: Exactly K via At Most K](#53-pattern-exactly-k-via-at-most-k)
- [54. Problem: Subarrays with K Different Integers](#54-problem-subarrays-with-k-different-integers)
- [55. Data Engineering Custom Problem: Count Windows with Exactly K Event Types](#55-data-engineering-custom-problem-count-windows-with-exactly-k-event-types)
- [56. Pattern: Max Consecutive Ones / Flip K](#56-pattern-max-consecutive-ones-flip-k)
- [57. Problem: Max Consecutive Ones III](#57-problem-max-consecutive-ones-iii)
- [58. Problem: Longest Repeating Character Replacement](#58-problem-longest-repeating-character-replacement)
- [59. Data Engineering Custom Problem: Longest Successful Run with K Failures](#59-data-engineering-custom-problem-longest-successful-run-with-k-failures)
- [60. Pattern: Sliding Window with Product](#60-pattern-sliding-window-with-product)
- [61. Problem: Subarray Product Less Than K](#61-problem-subarray-product-less-than-k)
- [62. Pattern: Time-Based Sliding Window](#62-pattern-time-based-sliding-window)
- [63. Data Engineering Custom Problem: Count Events in Last N Seconds](#63-data-engineering-custom-problem-count-events-in-last-n-seconds)
- [64. Data Engineering Custom Problem: Longest High-Quality Data Window](#64-data-engineering-custom-problem-longest-high-quality-data-window)
- [65. Data Engineering Custom Problem: Source Target Sorted Diff](#65-data-engineering-custom-problem-source-target-sorted-diff)
- [66. Pattern: Merge Two Sorted Arrays](#66-pattern-merge-two-sorted-arrays)
- [67. Problem: Merge Sorted Array](#67-problem-merge-sorted-array)
- [68. Pattern: Sessionization with Sliding Window](#68-pattern-sessionization-with-sliding-window)
- [69. Data Engineering Custom Problem: Longest Session Duration Window](#69-data-engineering-custom-problem-longest-session-duration-window)
- [70. Pattern Classification Drill](#70-pattern-classification-drill)
- [71. High-ROI LeetCode List](#71-high-roi-leetcode-list)
- [72. Practice Ladder](#72-practice-ladder)
- [73. 7-Day Two Pointers / Sliding Window Plan](#73-7-day-two-pointers-sliding-window-plan)
- [74. 30-Day Two Pointers / Sliding Window Plan](#74-30-day-two-pointers-sliding-window-plan)
- [75. Mock Set 1: Beginner](#75-mock-set-1-beginner)
- [76. Mock Set 2: Core Medium](#76-mock-set-2-core-medium)
- [77. Mock Set 3: Data Engineering Flavor](#77-mock-set-3-data-engineering-flavor)
- [78. Mock Set 4: Strong Candidate](#78-mock-set-4-strong-candidate)
- [79. Timed Drill Protocol](#79-timed-drill-protocol)
- [80. Review Checklist](#80-review-checklist)
- [81. Weakness Repair Map](#81-weakness-repair-map)
- [82. Communication Scripts](#82-communication-scripts)
- [83. Candidate Self-Review Questions](#83-candidate-self-review-questions)
- [84. Maintenance Drills](#84-maintenance-drills)
- [85. Progress Tracking Template](#85-progress-tracking-template)
- [86. Final Exit Test](#86-final-exit-test)
- [87. Final Summary](#87-final-summary)
- [88. Problem Card Appendix](#88-problem-card-appendix)
- [89. Data Engineering Custom Problem Card Appendix](#89-data-engineering-custom-problem-card-appendix)
- [90. Drill Appendix](#90-drill-appendix)
- [91. Quick Reference Cards](#91-quick-reference-cards)
<!-- END SECTION INDEX -->
