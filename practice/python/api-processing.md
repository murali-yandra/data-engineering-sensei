...
- [1. Purpose](#1-purpose)
- [2. Why API Processing Matters for Data Engineers](#2-why-api-processing-matters-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. API Processing Vocabulary](#4-api-processing-vocabulary)
- [5. HTTP Methods for Data Engineers](#5-http-methods-for-data-engineers)
- [6. HTTP Status Code Handling](#6-http-status-code-handling)
...
- [10. Basic API Request Template](#10-basic-api-request-template)
- [11. Request Function with Status Handling](#11-request-function-with-status-handling)
- [12. Retry with Exponential Backoff](#12-retry-with-exponential-backoff)
- [13. Rate Limit Handling](#13-rate-limit-handling)
- [14. Timeout Handling](#14-timeout-handling)
- [15. Pagination Overview](#15-pagination-overview)
- [16. Page Number Pagination](#16-page-number-pagination)
- [17. Offset Pagination](#17-offset-pagination)
- [18. Cursor Pagination](#18-cursor-pagination)
- [19. Next URL Pagination](#19-next-url-pagination)
- [20. Link Header Pagination](#20-link-header-pagination)
- [21. Incremental Sync](#21-incremental-sync)
- [22. Checkpointing](#22-checkpointing)
- [23. Idempotency](#23-idempotency)
- [24. JSON Processing Basics](#24-json-processing-basics)
- [25. Safe Nested Field Access](#25-safe-nested-field-access)
- [26. Flattening API Records](#26-flattening-api-records)
- [27. Record Validation](#27-record-validation)
- [28. Dead-Letter Records](#28-dead-letter-records)
- [29. Authentication Patterns](#29-authentication-patterns)
- [30. Environment Variables for Secrets](#30-environment-variables-for-secrets)
- [31. API Client Class Pattern](#31-api-client-class-pattern)
- [32. Streaming Records with Generators](#32-streaming-records-with-generators)
- [33. Batch Writing Pattern](#33-batch-writing-pattern)
- [34. Writing JSON Lines](#34-writing-json-lines)
- [35. Raw vs Clean Zones](#35-raw-vs-clean-zones)
- [36. Schema Drift](#36-schema-drift)
- [37. Deduplication](#37-deduplication)
- [38. Incremental Sync with Lookback Window](#38-incremental-sync-with-lookback-window)
- [39. API Extraction Function: End-to-End Skeleton](#39-api-extraction-function-end-to-end-skeleton)
- [40. Error Handling Strategy](#40-error-handling-strategy)
- [41. Observability](#41-observability)
- [42. API Ingestion Edge Cases](#42-api-ingestion-edge-cases)
- [43. Async API Processing](#43-async-api-processing)
- [44. Concurrency and Backpressure](#44-concurrency-and-backpressure)
- [45. Webhooks vs Polling](#45-webhooks-vs-polling)
- [46. Polling Export Job Pattern](#46-polling-export-job-pattern)
- [47. GraphQL API Processing](#47-graphql-api-processing)
- [48. API Design for Testability](#48-api-design-for-testability)
- [49. Mocking API Calls in Tests](#49-mocking-api-calls-in-tests)
- [50. Coding Problem: Fetch All Cursor Pages](#50-coding-problem-fetch-all-cursor-pages)
- [51. Coding Problem: Cursor Generator](#51-coding-problem-cursor-generator)
- [52. Coding Problem: Flatten Users API](#52-coding-problem-flatten-users-api)
- [53. Coding Problem: Split Valid and Invalid Records](#53-coding-problem-split-valid-and-invalid-records)
- [54. Coding Problem: Invalid Rate Threshold](#54-coding-problem-invalid-rate-threshold)
- [55. Coding Problem: Deduplicate API Records](#55-coding-problem-deduplicate-api-records)
- [56. Coding Problem: Build Query Params for Incremental Sync](#56-coding-problem-build-query-params-for-incremental-sync)
- [57. Coding Problem: Save and Load Checkpoint JSON](#57-coding-problem-save-and-load-checkpoint-json)
- [58. Coding Problem: Resume Cursor Sync](#58-coding-problem-resume-cursor-sync)
- [59. Coding Problem: Retry Decision Function](#59-coding-problem-retry-decision-function)
- [60. Coding Problem: Parse Retry-After](#60-coding-problem-parse-retry-after)
- [61. Data Engineering Custom Problem: Transactions API Sync](#61-data-engineering-custom-problem-transactions-api-sync)
- [62. Data Engineering Custom Problem: API Pagination Loop Bug](#62-data-engineering-custom-problem-api-pagination-loop-bug)
- [63. Data Engineering Custom Problem: API Count Drop](#63-data-engineering-custom-problem-api-count-drop)
- [64. Data Engineering Custom Problem: Token Expiry Mid-Run](#64-data-engineering-custom-problem-token-expiry-mid-run)
- [65. Data Engineering Custom Problem: Webhook Duplicate Delivery](#65-data-engineering-custom-problem-webhook-duplicate-delivery)
- [66. Data Engineering Custom Problem: Deleted Records](#66-data-engineering-custom-problem-deleted-records)
- [67. Data Engineering Custom Problem: API Schema Drift](#67-data-engineering-custom-problem-api-schema-drift)
- [68. Data Engineering Custom Problem: Large API Response](#68-data-engineering-custom-problem-large-api-response)
- [69. Data Engineering Custom Problem: Partial Write Failure](#69-data-engineering-custom-problem-partial-write-failure)
- [70. Data Engineering Custom Problem: API Backfill](#70-data-engineering-custom-problem-api-backfill)
- [71. API Processing Pattern Classification Drill](#71-api-processing-pattern-classification-drill)
- [72. High-ROI API Interview Topics](#72-high-roi-api-interview-topics)
- [73. Practice Ladder](#73-practice-ladder)
- [74. 7-Day API Processing Plan](#74-7-day-api-processing-plan)
- [75. 30-Day API Processing Plan](#75-30-day-api-processing-plan)
- [76. Mock Set 1: Python API Basics](#76-mock-set-1-python-api-basics)
- [77. Mock Set 2: Pagination and Retry](#77-mock-set-2-pagination-and-retry)
- [78. Mock Set 3: Data Engineering API Pipeline](#78-mock-set-3-data-engineering-api-pipeline)
- [79. Mock Set 4: Production Failure Scenarios](#79-mock-set-4-production-failure-scenarios)
...
- [90. Data Engineering Custom Scenario Appendix](#90-data-engineering-custom-scenario-appendix)
