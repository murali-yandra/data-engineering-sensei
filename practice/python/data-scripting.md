...
- [1. Purpose](#1-purpose)
- [2. Why Data Scripting Matters for Data Engineers](#2-why-data-scripting-matters-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. Python Data Scripting Vocabulary](#4-python-data-scripting-vocabulary)
- [5. Standard Answer Framework](#5-standard-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Core Python Tools](#7-core-python-tools)
- [8. File Handling Rules](#8-file-handling-rules)
- [9. CSV Reading](#9-csv-reading)
- [10. CSV Writing](#10-csv-writing)
- [11. JSON and JSONL](#11-json-and-jsonl)
- [12. JSONL Writing](#12-jsonl-writing)
- [13. Log Parsing Basics](#13-log-parsing-basics)
- [14. Validation Strategy](#14-validation-strategy)
- [15. Transform Strategy](#15-transform-strategy)
- [16. Splitting Valid and Invalid Records](#16-splitting-valid-and-invalid-records)
- [17. Invalid Record Threshold](#17-invalid-record-threshold)
- [18. Date and Timestamp Parsing](#18-date-and-timestamp-parsing)
- [19. Numeric Parsing](#19-numeric-parsing)
- [20. Aggregation with defaultdict](#20-aggregation-with-defaultdict)
- [21. Counting with Counter](#21-counting-with-counter)
- [22. Grouping Records](#22-grouping-records)
- [23. Deduplication by Key](#23-deduplication-by-key)
- [24. Latest Record Per ID](#24-latest-record-per-id)
- [25. Sorting Records](#25-sorting-records)
- [26. Top N Without Sorting Everything](#26-top-n-without-sorting-everything)
- [27. Flatten Nested JSON](#27-flatten-nested-json)
- [28. Exploding Nested Arrays](#28-exploding-nested-arrays)
- [29. Memory-Safe Processing](#29-memory-safe-processing)
- [30. Atomic Writes](#30-atomic-writes)
- [31. Idempotent Script Design](#31-idempotent-script-design)
- [32. Logging Basics](#32-logging-basics)
- [33. Command-Line Arguments](#33-command-line-arguments)
- [34. Testable Function Structure](#34-testable-function-structure)
- [35. Basic Unit Test Examples](#35-basic-unit-test-examples)
- [36. Common Data Scripting Edge Cases](#36-common-data-scripting-edge-cases)
- [37. Common Mistakes](#37-common-mistakes)
- [38. Coding Problem: CSV to Clean JSONL](#38-coding-problem-csv-to-clean-jsonl)
- [39. Coding Problem: Streaming CSV to JSONL](#39-coding-problem-streaming-csv-to-jsonl)
- [40. Coding Problem: Count Error Logs](#40-coding-problem-count-error-logs)
- [41. Coding Problem: Top Customers by Spend](#41-coding-problem-top-customers-by-spend)
- [42. Coding Problem: Latest User Profile](#42-coding-problem-latest-user-profile)
- [43. Coding Problem: Compare Two CSV Extracts](#43-coding-problem-compare-two-csv-extracts)
- [44. Coding Problem: Flatten Orders and Items](#44-coding-problem-flatten-orders-and-items)
- [45. Coding Problem: Sessionize Events](#45-coding-problem-sessionize-events)
- [46. Coding Problem: File Summary Metrics](#46-coding-problem-file-summary-metrics)
- [47. Coding Problem: Detect Duplicate IDs](#47-coding-problem-detect-duplicate-ids)
- [48. Coding Problem: Duplicate IDs with Row Numbers](#48-coding-problem-duplicate-ids-with-row-numbers)
- [49. Coding Problem: Normalize Enum Values](#49-coding-problem-normalize-enum-values)
- [50. Coding Problem: Data Quality Rules](#50-coding-problem-data-quality-rules)
- [51. Coding Problem: Merge Small Files](#51-coding-problem-merge-small-files)
- [52. Coding Problem: Generate Reconciliation Report](#52-coding-problem-generate-reconciliation-report)
- [53. Coding Problem: Detect Missing Dates](#53-coding-problem-detect-missing-dates)
- [54. Coding Problem: Partition Files by Date](#54-coding-problem-partition-files-by-date)
- [55. Coding Problem: Streaming Partition Writer](#55-coding-problem-streaming-partition-writer)
- [56. Coding Problem: Find Top Error Services from JSONL](#56-coding-problem-find-top-error-services-from-jsonl)
- [57. Coding Problem: Convert Wide to Long](#57-coding-problem-convert-wide-to-long)
- [58. Coding Problem: Long to Wide](#58-coding-problem-long-to-wide)
- [59. Coding Problem: Safe Schema Projection](#59-coding-problem-safe-schema-projection)
- [60. Coding Problem: Schema Drift Detector](#60-coding-problem-schema-drift-detector)
- [61. Coding Problem: Incremental File Filter](#61-coding-problem-incremental-file-filter)
- [62. Coding Problem: Checkpoint Local Script](#62-coding-problem-checkpoint-local-script)
- [63. Coding Problem: Find Files by Extension](#63-coding-problem-find-files-by-extension)
- [64. Coding Problem: File Manifest](#64-coding-problem-file-manifest)
- [65. Coding Problem: Compare File Manifests](#65-coding-problem-compare-file-manifests)
- [66. Coding Problem: Redact PII Fields](#66-coding-problem-redact-pii-fields)
- [67. Coding Problem: Recursive Flatten Dictionary](#67-coding-problem-recursive-flatten-dictionary)
- [68. Coding Problem: Normalize Column Names](#68-coding-problem-normalize-column-names)
- [69. Coding Problem: Rename Record Keys](#69-coding-problem-rename-record-keys)
- [70. Coding Problem: Row Hash](#70-coding-problem-row-hash)
- [71. Coding Problem: Change Detection](#71-coding-problem-change-detection)
- [72. Coding Problem: Generate SQL Insert Statements](#72-coding-problem-generate-sql-insert-statements)
- [73. Coding Problem: Build Batch SQL Values](#73-coding-problem-build-batch-sql-values)
- [74. Coding Problem: Config-Driven Transformation](#74-coding-problem-config-driven-transformation)
- [75. Coding Problem: Multi-File Processing Summary](#75-coding-problem-multi-file-processing-summary)
- [76. Coding Problem: Detect Header Repeated in CSV Body](#76-coding-problem-detect-header-repeated-in-csv-body)
- [77. Coding Problem: Detect Footer Row](#77-coding-problem-detect-footer-row)
- [78. Coding Problem: Safe Division in Metrics](#78-coding-problem-safe-division-in-metrics)
- [79. Coding Problem: Rolling Daily Counts](#79-coding-problem-rolling-daily-counts)
- [80. Coding Problem: Running Total by Date](#80-coding-problem-running-total-by-date)
- [81. Data Scripting Pattern Classification Drill](#81-data-scripting-pattern-classification-drill)
- [82. High-ROI Python Data Scripting Topics](#82-high-roi-python-data-scripting-topics)
- [83. Practice Ladder](#83-practice-ladder)
- [84. 7-Day Data Scripting Plan](#84-7-day-data-scripting-plan)
- [85. 30-Day Data Scripting Plan](#85-30-day-data-scripting-plan)
- [86. Mock Set 1: Data Scripting Basics](#86-mock-set-1-data-scripting-basics)
- [87. Mock Set 2: Aggregation and Dedupe](#87-mock-set-2-aggregation-and-dedupe)
- [88. Mock Set 3: Realistic Data Processing](#88-mock-set-3-realistic-data-processing)
- [89. Mock Set 4: Production Scripting](#89-mock-set-4-production-scripting)
- [90. Timed Drill Protocol](#90-timed-drill-protocol)
- [91. Review Checklist](#91-review-checklist)
- [92. Weakness Repair Map](#92-weakness-repair-map)
- [93. Communication Scripts](#93-communication-scripts)
- [94. Candidate Self-Review Questions](#94-candidate-self-review-questions)
- [95. Maintenance Drills](#95-maintenance-drills)
- [96. Progress Tracking Template](#96-progress-tracking-template)
- [97. Final Exit Test](#97-final-exit-test)
- [98. Final Summary](#98-final-summary)
- [99. Problem Card Appendix](#99-problem-card-appendix)
- [100. Data Engineering Custom Scenario Appendix](#100-data-engineering-custom-scenario-appendix)
- [101. Drill Appendix](#101-drill-appendix)
- [102. Quick Reference Cards](#102-quick-reference-cards)
<!-- END SECTION INDEX -->
