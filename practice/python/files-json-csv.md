...
- [1. Purpose](#1-purpose)
- [2. Why Files, JSON, and CSV Matter for Data Engineers](#2-why-files-json-and-csv-matter-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. File Processing Vocabulary](#4-file-processing-vocabulary)
- [5. Standard Answer Framework](#5-standard-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Python Standard Library Tools](#7-python-standard-library-tools)
- [8. Pathlib Basics](#8-pathlib-basics)
- [9. Context Managers](#9-context-managers)
- [10. Encoding and Newline Rules](#10-encoding-and-newline-rules)
- [11. Reading Text Files Line by Line](#11-reading-text-files-line-by-line)
- [12. Writing Text Files](#12-writing-text-files)
- [13. CSV Basics](#13-csv-basics)
- [14. Reading CSV with DictReader](#14-reading-csv-with-dictreader)
- [15. Validating CSV Headers](#15-validating-csv-headers)
- [16. Handling Extra CSV Columns](#16-handling-extra-csv-columns)
- [17. Writing CSV with DictWriter](#17-writing-csv-with-dictwriter)
- [18. CSV Dialects and Delimiters](#18-csv-dialects-and-delimiters)
- [19. CSV Missing Values](#19-csv-missing-values)
- [20. CSV Row-Level Validation](#20-csv-row-level-validation)
- [21. CSV Bad Records Pattern](#21-csv-bad-records-pattern)
- [22. JSON Basics](#22-json-basics)
- [23. JSON Shape Validation](#23-json-shape-validation)
- [24. JSON Decode Errors](#24-json-decode-errors)
- [25. JSONL Basics](#25-jsonl-basics)
- [26. Reading JSONL Safely](#26-reading-jsonl-safely)
- [27. Writing JSONL](#27-writing-jsonl)
- [28. JSON vs JSONL Decision Table](#28-json-vs-jsonl-decision-table)
- [29. Safe Nested JSON Access](#29-safe-nested-json-access)
- [30. Flattening Nested JSON](#30-flattening-nested-json)
- [31. Exploding Nested Arrays](#31-exploding-nested-arrays)
- [32. Recursive Dictionary Flattening](#32-recursive-dictionary-flattening)
- [33. CSV to JSONL Conversion](#33-csv-to-jsonl-conversion)
- [34. CSV to Clean JSONL with Invalid Output](#34-csv-to-clean-jsonl-with-invalid-output)
- [35. JSONL to CSV Conversion](#35-jsonl-to-csv-conversion)
- [36. JSON Array to JSONL](#36-json-array-to-jsonl)
- [37. JSON Object Data Field to JSONL](#37-json-object-data-field-to-jsonl)
- [38. File Manifest Basics](#38-file-manifest-basics)
- [39. Counting File Rows](#39-counting-file-rows)
- [40. File Checksums](#40-file-checksums)
- [41. Enhanced File Manifest](#41-enhanced-file-manifest)
- [42. Comparing File Manifests](#42-comparing-file-manifests)
- [43. Atomic File Writes](#43-atomic-file-writes)
- [44. Atomic CSV Write](#44-atomic-csv-write)
- [45. Atomic JSONL Write](#45-atomic-jsonl-write)
- [46. Idempotency for File Scripts](#46-idempotency-for-file-scripts)
- [47. File Discovery](#47-file-discovery)
- [48. Processing Multiple Files](#48-processing-multiple-files)
- [49. Checkpoint Processed Files](#49-checkpoint-processed-files)
- [50. Handling Repeated CSV Headers](#50-handling-repeated-csv-headers)
- [51. Handling Footer Rows](#51-handling-footer-rows)
- [52. Handling BOM in CSV Headers](#52-handling-bom-in-csv-headers)
- [53. Normalizing Column Names](#53-normalizing-column-names)
- [54. Projecting Records to Fixed Schema](#54-projecting-records-to-fixed-schema)
- [55. Schema Drift Report](#55-schema-drift-report)
- [56. Comparing Two CSV Files by ID](#56-comparing-two-csv-files-by-id)
- [57. Streaming Sorted CSV Comparison](#57-streaming-sorted-csv-comparison)
- [58. Row Hashes for Change Detection](#58-row-hashes-for-change-detection)
- [59. Detect Inserts, Updates, Deletes Between JSONL Files](#59-detect-inserts-updates-deletes-between-jsonl-files)
- [60. Redacting Sensitive Fields](#60-redacting-sensitive-fields)
- [61. Logging for File Scripts](#61-logging-for-file-scripts)
- [62. Command-Line File Script](#62-command-line-file-script)
- [63. Testing File Logic](#63-testing-file-logic)
- [64. Common File Edge Cases](#64-common-file-edge-cases)
- [65. Common Mistakes](#65-common-mistakes)
- [66. Coding Problem: Count Rows in CSV](#66-coding-problem-count-rows-in-csv)
- [67. Coding Problem: Validate CSV Required Columns](#67-coding-problem-validate-csv-required-columns)
- [68. Coding Problem: Read CSV and Normalize Headers](#68-coding-problem-read-csv-and-normalize-headers)
- [69. Coding Problem: CSV Summary Report](#69-coding-problem-csv-summary-report)
- [70. Coding Problem: Read JSON Data Array](#70-coding-problem-read-json-data-array)
- [71. Coding Problem: Write Invalid JSONL Lines Separately](#71-coding-problem-write-invalid-jsonl-lines-separately)
- [72. Coding Problem: Flatten JSONL Orders](#72-coding-problem-flatten-jsonl-orders)
- [73. Coding Problem: Explode Order Items to CSV](#73-coding-problem-explode-order-items-to-csv)
- [74. Coding Problem: Detect Duplicate IDs in JSONL](#74-coding-problem-detect-duplicate-ids-in-jsonl)
- [75. Coding Problem: Merge JSONL Files](#75-coding-problem-merge-jsonl-files)
- [76. Coding Problem: Split CSV by Date](#76-coding-problem-split-csv-by-date)
- [77. Coding Problem: Build Manifest for CSV Folder](#77-coding-problem-build-manifest-for-csv-folder)
- [78. Coding Problem: Find Missing Daily Files](#78-coding-problem-find-missing-daily-files)
- [79. Coding Problem: Validate JSONL Required Fields](#79-coding-problem-validate-jsonl-required-fields)
- [80. Coding Problem: Convert JSONL to Aggregated CSV](#80-coding-problem-convert-jsonl-to-aggregated-csv)
- [81. Pattern Classification Drill](#81-pattern-classification-drill)
- [82. High-ROI File/JSON/CSV Topics](#82-high-roi-filejsoncsv-topics)
- [83. Practice Ladder](#83-practice-ladder)
- [84. 7-Day Files/JSON/CSV Plan](#84-7-day-filesjsoncsv-plan)
- [85. 30-Day Files/JSON/CSV Plan](#85-30-day-filesjsoncsv-plan)
- [86. Mock Set 1: File Basics](#86-mock-set-1-file-basics)
- [87. Mock Set 2: CSV Processing](#87-mock-set-2-csv-processing)
- [88. Mock Set 3: JSON and JSONL](#88-mock-set-3-json-and-jsonl)
- [89. Mock Set 4: Production File Ingestion](#89-mock-set-4-production-file-ingestion)
...
- [100. Data Engineering Scenario Appendix](#100-data-engineering-scenario-appendix)
