...
84 sections. Jump to the one you need rather than reading this file end to end.

- [1. Purpose](#1-purpose)
- [2. Why This Matters for Data Engineers](#2-why-this-matters-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. Vocabulary](#4-vocabulary)
- [5. Standard Interview Answer Framework](#5-standard-interview-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Testing Pyramid for Data Engineering](#7-testing-pyramid-for-data-engineering)
- [8. What to Test in Data Pipelines](#8-what-to-test-in-data-pipelines)
- [9. Pure Functions for Testability](#9-pure-functions-for-testability)
- [10. Basic pytest Style](#10-basic-pytest-style)
- [11. Assertions](#11-assertions)
- [12. Test Naming](#12-test-naming)
- [13. Fixtures and Test Data](#13-fixtures-and-test-data)
- [14. Parameterized Tests](#14-parameterized-tests)
- [15. Testing Exceptions](#15-testing-exceptions)
- [16. Testing Invalid Records](#16-testing-invalid-records)
- [17. Testing Transformations](#17-testing-transformations)
- [18. Testing Aggregations](#18-testing-aggregations)
- [19. Testing Deduplication](#19-testing-deduplication)
- [20. Testing Joins and Reconciliation](#20-testing-joins-and-reconciliation)
- [21. Testing File Processing with tmp_path](#21-testing-file-processing-with-tmppath)
- [22. Testing API Clients with Fakes](#22-testing-api-clients-with-fakes)
- [23. Testing Retry Classification](#23-testing-retry-classification)
- [24. Testing Rate Limit Handling](#24-testing-rate-limit-handling)
- [25. Testing Checkpoints](#25-testing-checkpoints)
- [26. Testing Idempotency](#26-testing-idempotency)
- [27. Testing Logging](#27-testing-logging)
- [28. Logging Basics](#28-logging-basics)
- [29. Structured Logging](#29-structured-logging)
- [30. What to Log in Data Pipelines](#30-what-to-log-in-data-pipelines)
- [31. Avoid Logging Secrets and PII](#31-avoid-logging-secrets-and-pii)
- [32. Error Classification](#32-error-classification)
- [33. Exception Handling Principles](#33-exception-handling-principles)
- [34. Bare Except Is Dangerous](#34-bare-except-is-dangerous)
- [35. Raising Meaningful Errors](#35-raising-meaningful-errors)
- [36. Row-Level vs Job-Level Errors](#36-row-level-vs-job-level-errors)
- [37. Dead-Letter Design](#37-dead-letter-design)
- [38. Invalid Rate Thresholds](#38-invalid-rate-thresholds)
- [39. Retry Policy](#39-retry-policy)
- [40. Exponential Backoff with Jitter](#40-exponential-backoff-with-jitter)
- [41. Timeouts](#41-timeouts)
- [42. Partial Failure Handling](#42-partial-failure-handling)
- [43. Idempotency Error Handling](#43-idempotency-error-handling)
- [44. Observability Metrics](#44-observability-metrics)
- [45. Alerting](#45-alerting)
- [46. Testing Logs, Metrics, and Alerts Conceptually](#46-testing-logs-metrics-and-alerts-conceptually)
- [47. Error Handling for Files](#47-error-handling-for-files)
- [48. Error Handling for APIs](#48-error-handling-for-apis)
- [49. Error Handling for Databases/Warehouses](#49-error-handling-for-databaseswarehouses)
- [50. Error Handling for Orchestration](#50-error-handling-for-orchestration)
- [51. Coding Problem: Validate Required Columns](#51-coding-problem-validate-required-columns)
- [52. Coding Problem: Split Valid and Invalid Rows](#52-coding-problem-split-valid-and-invalid-rows)
- [53. Coding Problem: Redact Sensitive Fields](#53-coding-problem-redact-sensitive-fields)
- [54. Coding Problem: Retry Decision](#54-coding-problem-retry-decision)
- [55. Coding Problem: Retry Wrapper](#55-coding-problem-retry-wrapper)
- [56. Coding Problem: Dead-Letter Writer](#56-coding-problem-dead-letter-writer)
- [57. Coding Problem: Logging Summary](#57-coding-problem-logging-summary)
- [58. Coding Problem: Idempotent Output Write](#58-coding-problem-idempotent-output-write)
- [59. Coding Problem: Pipeline Summary Function](#59-coding-problem-pipeline-summary-function)
- [60. Coding Problem: Schema Drift Detector](#60-coding-problem-schema-drift-detector)
- [61. Testing Pattern Classification Drill](#61-testing-pattern-classification-drill)
- [62. Error Classification Drill](#62-error-classification-drill)
- [63. High-ROI Topics](#63-high-roi-topics)
- [64. Practice Ladder](#64-practice-ladder)
- [65. 7-Day Plan](#65-7-day-plan)
- [66. 30-Day Plan](#66-30-day-plan)
- [67. Mock Set 1: Testing Basics](#67-mock-set-1-testing-basics)
- [68. Mock Set 2: Data Pipeline Tests](#68-mock-set-2-data-pipeline-tests)
- [69. Mock Set 3: I/O and Dependency Tests](#69-mock-set-3-io-and-dependency-tests)
- [70. Mock Set 4: Logging and Error Handling](#70-mock-set-4-logging-and-error-handling)
- [71. Timed Drill Protocol](#71-timed-drill-protocol)
- [72. Review Checklist](#72-review-checklist)
- [73. Weakness Repair Map](#73-weakness-repair-map)
- [74. Communication Scripts](#74-communication-scripts)
- [75. Candidate Self-Review Questions](#75-candidate-self-review-questions)
- [76. Maintenance Drills](#76-maintenance-drills)
- [77. Progress Tracking Template](#77-progress-tracking-template)
- [78. Final Exit Test](#78-final-exit-test)
- [79. Final Summary](#79-final-summary)
- [80. Problem Card Appendix](#80-problem-card-appendix)
- [81. Data Engineering Scenario Appendix](#81-data-engineering-scenario-appendix)
- [82. Drill Appendix](#82-drill-appendix)
- [83. Quick Reference Cards](#83-quick-reference-cards)
- [84. Interview FAQ](#84-interview-faq)
<!-- END SECTION INDEX -->
