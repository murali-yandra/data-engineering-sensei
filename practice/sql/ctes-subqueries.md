...
- [1. Purpose](#1-purpose)
- [2. Why CTEs and Subqueries Matter for Data Engineers](#2-why-ctes-and-subqueries-matter-for-data-engineers)
...
- [7. CTE Syntax](#7-cte-syntax)
- [8. Subquery Syntax Overview](#8-subquery-syntax-overview)
- [9. CTE vs Subquery Decision Table](#9-cte-vs-subquery-decision-table)
- [10. Naming CTEs](#10-naming-ctes)
- [11. CTE Grain Discipline](#11-cte-grain-discipline)
- [12. Example: Multi-Step Revenue Query](#12-example-multi-step-revenue-query)
- [13. Derived Tables](#13-derived-tables)
- [14. Scalar Subqueries](#14-scalar-subqueries)
- [15. IN Subqueries](#15-in-subqueries)
- [16. EXISTS Subqueries](#16-exists-subqueries)
- [17. NOT EXISTS Anti-Join](#17-not-exists-anti-join)
- [18. NOT IN NULL Trap](#18-not-in-null-trap)
- [19. Correlated Subqueries](#19-correlated-subqueries)
- [20. Rewriting Correlated Subquery as Join](#20-rewriting-correlated-subquery-as-join)
- [21. Filtering Aggregated Results](#21-filtering-aggregated-results)
- [22. Filtering Window Function Results](#22-filtering-window-function-results)
- [23. CTE for Deduplication](#23-cte-for-deduplication)
- [24. CTE for Latest Snapshot](#24-cte-for-latest-snapshot)
- [25. CTE for First Purchase](#25-cte-for-first-purchase)
- [26. CTE for Business Metric Stages](#26-cte-for-business-metric-stages)
- [27. CTE for Source-Target Reconciliation](#27-cte-for-source-target-reconciliation)
- [28. CTE for Avoiding Double Counting](#28-cte-for-avoiding-double-counting)
- [29. CTE for Funnel Analysis](#29-cte-for-funnel-analysis)
- [30. CTE for Retention](#30-cte-for-retention)
- [31. Nested CTEs vs Many CTEs](#31-nested-ctes-vs-many-ctes)
- [32. Reusing CTEs](#32-reusing-ctes)
- [33. CTE Materialization and Performance](#33-cte-materialization-and-performance)
- [34. Subquery Performance Principles](#34-subquery-performance-principles)
- [35. Recursive CTE Basics](#35-recursive-cte-basics)
- [36. Recursive CTE for Date Series](#36-recursive-cte-for-date-series)
- [37. Subquery in SELECT for Percent of Total](#37-subquery-in-select-for-percent-of-total)
- [38. Subquery in HAVING](#38-subquery-in-having)
- [39. EXISTS vs JOIN](#39-exists-vs-join)
- [40. NOT EXISTS vs LEFT JOIN Anti-Join](#40-not-exists-vs-left-join-anti-join)
- [41. CTE for Data Quality Checks](#41-cte-for-data-quality-checks)
- [42. CTE for Orphan Records](#42-cte-for-orphan-records)
- [43. CTE for Missing Dates](#43-cte-for-missing-dates)
- [44. CTE for Incremental Watermark Logic](#44-cte-for-incremental-watermark-logic)
- [45. CTE for Upsert/Merge Staging Prep](#45-cte-for-upsertmerge-staging-prep)
- [46. Recursive CTE for Employee Hierarchy](#46-recursive-cte-for-employee-hierarchy)
- [47. Recursive CTE Cycle Risk](#47-recursive-cte-cycle-risk)
- [48. Common CTE/Subquery Mistakes](#48-common-ctesubquery-mistakes)
- [49. Debugging CTE Queries](#49-debugging-cte-queries)
- [50. Validation Queries](#50-validation-queries)
- [51. Pattern: Base Filter CTE](#51-pattern-base-filter-cte)
- [52. Pattern: Aggregate Then Join](#52-pattern-aggregate-then-join)
- [53. Pattern: Join Then Aggregate](#53-pattern-join-then-aggregate)
- [54. Pattern: Semi-Join with EXISTS](#54-pattern-semi-join-with-exists)
- [55. Pattern: Anti-Join with NOT EXISTS](#55-pattern-anti-join-with-not-exists)
- [56. Pattern: Window Filter CTE](#56-pattern-window-filter-cte)
- [57. Pattern: Compare to Overall Aggregate](#57-pattern-compare-to-overall-aggregate)
- [58. Pattern: Compare to Group Aggregate](#58-pattern-compare-to-group-aggregate)
- [59. Pattern: Isolate Final SELECT](#59-pattern-isolate-final-select)
- [60. Case Study: Complete Metric Query](#60-case-study-complete-metric-query)
- [61. SQL Execution Order Reminder](#61-sql-execution-order-reminder)
- [62. CTEs in CREATE TABLE AS](#62-ctes-in-create-table-as)
- [63. CTEs in INSERT INTO SELECT](#63-ctes-in-insert-into-select)
- [64. CTEs in MERGE Preparation](#64-ctes-in-merge-preparation)
- [65. Interview Clarifying Questions](#65-interview-clarifying-questions)
- [66. Communication Scripts](#66-communication-scripts)
- [67. Practice Problem 1: Customers Above Average Revenue](#67-practice-problem-1-customers-above-average-revenue)
- [68. Practice Problem 2: Users With No Events](#68-practice-problem-2-users-with-no-events)
- [69. Practice Problem 3: First and Latest Order Per User](#69-practice-problem-3-first-and-latest-order-per-user)
- [70. Practice Problem 4: Products Never Purchased](#70-practice-problem-4-products-never-purchased)
- [71. Practice Problem 5: Daily Revenue with Missing Dates](#71-practice-problem-5-daily-revenue-with-missing-dates)
- [72. Practice Problem 6: Duplicate Detection and Dedup](#72-practice-problem-6-duplicate-detection-and-dedup)
- [73. Practice Problem 7: Orders Greater Than User Average](#73-practice-problem-7-orders-greater-than-user-average)
- [74. Practice Problem 8: Active Users with Purchases](#74-practice-problem-8-active-users-with-purchases)
- [75. Practice Problem 9: Latest Plan at Order Time](#75-practice-problem-9-latest-plan-at-order-time)
- [76. Practice Problem 10: Category Revenue Share](#76-practice-problem-10-category-revenue-share)
- [77. Practice Problem 11: Users With More Than One Account](#77-practice-problem-11-users-with-more-than-one-account)
- [78. Practice Problem 12: Orders Without Successful Payment](#78-practice-problem-12-orders-without-successful-payment)
- [79. Practice Problem 13: Monthly New and Repeat Buyers](#79-practice-problem-13-monthly-new-and-repeat-buyers)
- [80. Practice Problem 14: Top 2 Categories Per Country](#80-practice-problem-14-top-2-categories-per-country)
- [81. Practice Problem 15: Month-over-Month Active User Growth](#81-practice-problem-15-month-over-month-active-user-growth)
- [82. CTE/Subquery Pattern Classification Drill](#82-ctesubquery-pattern-classification-drill)
- [83. High-ROI Topics](#83-high-roi-topics)
- [84. 7-Day CTE/Subquery Plan](#84-7-day-ctesubquery-plan)
- [85. 30-Day CTE/Subquery Plan](#85-30-day-ctesubquery-plan)
- [86. Mock Set 1: CTE Fundamentals](#86-mock-set-1-cte-fundamentals)
- [87. Mock Set 2: Subqueries and EXISTS](#87-mock-set-2-subqueries-and-exists)
- [88. Mock Set 3: Window CTEs](#88-mock-set-3-window-ctes)
- [89. Mock Set 4: Data Engineering CTE Cases](#89-mock-set-4-data-engineering-cte-cases)
...
- [102. CTE/Subquery Interview FAQ](#102-ctesubquery-interview-faq)
<!-- END SECTION INDEX -->
