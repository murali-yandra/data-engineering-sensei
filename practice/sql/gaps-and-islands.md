...
102 sections. Jump to the one you need rather than reading this file end to end.

- [1. Purpose](#1-purpose)
- [2. Why Gaps and Islands Matter for Data Engineers](#2-why-gaps-and-islands-matter-for-data-engineers)
...
- [7. The Two Main Patterns](#7-the-two-main-patterns)
- [8. Date Arithmetic Dialect Notes](#8-date-arithmetic-dialect-notes)
- [9. Why date - row_number Works](#9-why-date---rownumber-works)
- [10. Deduplicate Before Streak Logic](#10-deduplicate-before-streak-logic)
- [11. Case 1: Users Active for At Least 3 Consecutive Days](#11-case-1-users-active-for-at-least-3-consecutive-days)
- [12. Case 2: Longest Login Streak Per User](#12-case-2-longest-login-streak-per-user)
- [13. Case 3: Missing Daily Partitions](#13-case-3-missing-daily-partitions)
- [14. Case 4: Group Missing Dates Into Gaps](#14-case-4-group-missing-dates-into-gaps)
- [15. Case 5: Missing Sequence Numbers](#15-case-5-missing-sequence-numbers)
- [16. Case 6: Find Gaps Between User Events](#16-case-6-find-gaps-between-user-events)
- [17. Case 7: Sessionize Events by 30-Minute Gap](#17-case-7-sessionize-events-by-30-minute-gap)
- [18. Case 8: Consecutive Failed Payments](#18-case-8-consecutive-failed-payments)
- [19. Case 9: Status Runs](#19-case-9-status-runs)
- [20. Case 10: Inventory Stockout Periods](#20-case-10-inventory-stockout-periods)
- [21. Case 11: Subscription Active Periods from Daily Activity](#21-case-11-subscription-active-periods-from-daily-activity)
- [22. Case 12: Gaps Between Subscription Periods](#22-case-12-gaps-between-subscription-periods)
- [23. Case 13: Merge Overlapping Intervals](#23-case-13-merge-overlapping-intervals)
- [24. Case 14: Detect Overlapping SCD Effective Intervals](#24-case-14-detect-overlapping-scd-effective-intervals)
- [25. Case 15: Find Non-Overlapping Gaps in SCD Intervals](#25-case-15-find-non-overlapping-gaps-in-scd-intervals)
- [26. Case 16: Consecutive Order Months](#26-case-16-consecutive-order-months)
- [27. Case 17: Consecutive Weeks Active](#27-case-17-consecutive-weeks-active)
- [28. Case 18: Inactive Users for More Than 30 Days Between Events](#28-case-18-inactive-users-for-more-than-30-days-between-events)
- [29. Case 19: Dormant Users as of Analysis Date](#29-case-19-dormant-users-as-of-analysis-date)
- [30. Case 20: Consecutive Revenue Drop Days](#30-case-20-consecutive-revenue-drop-days)
- [31. Case 21: Consecutive Increasing Spend Months](#31-case-21-consecutive-increasing-spend-months)
- [32. Case 22: Uptime/Downtime Periods](#32-case-22-uptimedowntime-periods)
- [33. Case 23: Sensor Outage Periods](#33-case-23-sensor-outage-periods)
- [34. Case 24: Consecutive Absence Days](#34-case-24-consecutive-absence-days)
- [35. Case 25: Consecutive Business Days With No Orders](#35-case-25-consecutive-business-days-with-no-orders)
- [36. Case 26: Consecutive Same Category Purchases](#36-case-26-consecutive-same-category-purchases)
- [37. Case 27: Consecutive Login Failures Before Success](#37-case-27-consecutive-login-failures-before-success)
- [38. Case 28: Missing IDs in an Auto-Increment Table](#38-case-28-missing-ids-in-an-auto-increment-table)
- [39. Case 29: Longest Stockout Per Product](#39-case-29-longest-stockout-per-product)
- [40. Case 30: Longest Inactivity Gap Per User](#40-case-30-longest-inactivity-gap-per-user)
- [41. Case 31: Find Periods With Zero Revenue](#41-case-31-find-periods-with-zero-revenue)
- [42. Case 32: Consecutive SLA Breach Days](#42-case-32-consecutive-sla-breach-days)
- [43. Case 33: Consecutive Failed Jobs](#43-case-33-consecutive-failed-jobs)
- [44. Case 34: Consecutive Late Arrivals](#44-case-34-consecutive-late-arrivals)
- [45. Case 35: Consecutive Negative Balances](#45-case-35-consecutive-negative-balances)
- [46. Case 36: Merge Adjacent Intervals Only](#46-case-36-merge-adjacent-intervals-only)
- [47. Case 37: Find Gaps After Merging Intervals](#47-case-37-find-gaps-after-merging-intervals)
- [48. Case 38: Campaign Active Islands](#48-case-38-campaign-active-islands)
- [49. Case 39: Consecutive Low Inventory Days by Category](#49-case-39-consecutive-low-inventory-days-by-category)
- [50. Case 40: Detect Broken Event Ordering](#50-case-40-detect-broken-event-ordering)
- [51. Case 41: Consecutive Days Above Threshold](#51-case-41-consecutive-days-above-threshold)
- [52. Case 42: Retention Streaks After Signup](#52-case-42-retention-streaks-after-signup)
- [53. Case 43: First Gap After Signup](#53-case-43-first-gap-after-signup)
- [54. Case 44: Product Price Stable Periods](#54-case-44-product-price-stable-periods)
- [55. Case 45: Merge User Sessions From Existing Session Intervals](#55-case-45-merge-user-sessions-from-existing-session-intervals)
- [56. Pattern: Consecutive Dates with ROW_NUMBER](#56-pattern-consecutive-dates-with-rownumber)
- [57. Pattern: Consecutive Numbers with ROW_NUMBER](#57-pattern-consecutive-numbers-with-rownumber)
- [58. Pattern: Custom Gap Threshold with LAG](#58-pattern-custom-gap-threshold-with-lag)
- [59. Pattern: Same-Status Islands](#59-pattern-same-status-islands)
- [60. Pattern: Missing Expected Values](#60-pattern-missing-expected-values)
- [61. Pattern: Merge Overlapping Intervals](#61-pattern-merge-overlapping-intervals)
- [62. Pattern: Find Gaps Between Intervals](#62-pattern-find-gaps-between-intervals)
- [63. Pattern: Detect Overlaps](#63-pattern-detect-overlaps)
- [64. Pattern: Business Calendar Streaks](#64-pattern-business-calendar-streaks)
- [65. Pattern Selection Guide](#65-pattern-selection-guide)
- [66. Validation Checklist](#66-validation-checklist)
- [67. Edge Cases](#67-edge-cases)
- [68. Common Mistakes](#68-common-mistakes)
- [69. Performance Principles](#69-performance-principles)
- [70. SQL Dialect Translation Cheatsheet](#70-sql-dialect-translation-cheatsheet)
- [71. Practice Problem 1: Active Users for 5 Consecutive Days](#71-practice-problem-1-active-users-for-5-consecutive-days)
- [72. Practice Problem 2: Longest Consecutive Order Days](#72-practice-problem-2-longest-consecutive-order-days)
- [73. Practice Problem 3: Missing Sales Dates by Store](#73-practice-problem-3-missing-sales-dates-by-store)
- [74. Practice Problem 4: Group Missing Sales Dates](#74-practice-problem-4-group-missing-sales-dates)
- [75. Practice Problem 5: Sessionize Page Views](#75-practice-problem-5-sessionize-page-views)
- [76. Practice Problem 6: Consecutive Failed Pipeline Runs](#76-practice-problem-6-consecutive-failed-pipeline-runs)
- [77. Practice Problem 7: Merge Overlapping Bookings](#77-practice-problem-7-merge-overlapping-bookings)
- [78. Practice Problem 8: Detect Booking Conflicts](#78-practice-problem-8-detect-booking-conflicts)
- [79. Practice Problem 9: Missing Sequence Ranges Per Device](#79-practice-problem-9-missing-sequence-ranges-per-device)
- [80. Practice Problem 10: Consecutive Workday Attendance](#80-practice-problem-10-consecutive-workday-attendance)
- [81. Pattern Classification Drill](#81-pattern-classification-drill)
- [82. High-ROI Topics](#82-high-roi-topics)
- [83. 7-Day Gaps and Islands Plan](#83-7-day-gaps-and-islands-plan)
- [84. 30-Day Gaps and Islands Plan](#84-30-day-gaps-and-islands-plan)
- [85. Mock Set 1: Basic Islands](#85-mock-set-1-basic-islands)
- [86. Mock Set 2: Gaps and Missing Values](#86-mock-set-2-gaps-and-missing-values)
- [87. Mock Set 3: Sessionization and Status Runs](#87-mock-set-3-sessionization-and-status-runs)
- [88. Mock Set 4: Interval Problems](#88-mock-set-4-interval-problems)
- [89. Timed Drill Protocol](#89-timed-drill-protocol)
- [90. Review Checklist](#90-review-checklist)
- [91. Weakness Repair Map](#91-weakness-repair-map)
- [92. Communication Scripts](#92-communication-scripts)
- [93. Candidate Self-Review Questions](#93-candidate-self-review-questions)
- [94. Maintenance Drills](#94-maintenance-drills)
- [95. Progress Tracking Template](#95-progress-tracking-template)
- [96. Final Exit Test](#96-final-exit-test)
- [97. Final Summary](#97-final-summary)
- [98. Problem Card Appendix](#98-problem-card-appendix)
- [99. Data Engineering Scenario Appendix](#99-data-engineering-scenario-appendix)
- [100. Drill Appendix](#100-drill-appendix)
- [101. Quick Reference Cards](#101-quick-reference-cards)
- [102. Gaps and Islands FAQ](#102-gaps-and-islands-faq)
<!-- END SECTION INDEX -->
