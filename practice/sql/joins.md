...
- [1. Purpose](#1-purpose)
- [2. Why Joins Matter for Data Engineers](#2-why-joins-matter-for-data-engineers)
- [3. Core Mental Model](#3-core-mental-model)
- [4. Join Vocabulary](#4-join-vocabulary)
- [5. Standard Answer Framework](#5-standard-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Join Types Overview](#7-join-types-overview)
- [8. Join Cardinality](#8-join-cardinality)
- [9. Join Row Count Predictions](#9-join-row-count-predictions)
- [10. Basic INNER JOIN](#10-basic-inner-join)
- [11. Basic LEFT JOIN](#11-basic-left-join)
- [12. LEFT JOIN Filter Trap](#12-left-join-filter-trap)
- [13. FULL OUTER JOIN](#13-full-outer-join)
- [14. CROSS JOIN](#14-cross-join)
- [15. Semi-Join with EXISTS](#15-semi-join-with-exists)
- [16. Anti-Join with NOT EXISTS](#16-anti-join-with-not-exists)
- [17. NOT IN NULL Trap](#17-not-in-null-trap)
- [18. NULL Join Keys](#18-null-join-keys)
- [19. Composite Join Keys](#19-composite-join-keys)
- [20. Joining Fact to Dimension](#20-joining-fact-to-dimension)
- [21. Joining Order Headers to Order Items](#21-joining-order-headers-to-order-items)
- [22. Aggregate Before Join](#22-aggregate-before-join)
- [23. Join Then Aggregate](#23-join-then-aggregate)
- [24. Avoid Joining Two Fact Tables at Detail Grain](#24-avoid-joining-two-fact-tables-at-detail-grain)
- [25. Many-to-Many Joins](#25-many-to-many-joins)
- [26. Join Explosion Detection](#26-join-explosion-detection)
- [27. Deduplicate Before Join](#27-deduplicate-before-join)
- [28. Orphan Records](#28-orphan-records)
- [29. Unmatched Dimension Records](#29-unmatched-dimension-records)
- [30. Conversion Metrics with LEFT JOIN](#30-conversion-metrics-with-left-join)
- [31. Retention Joins](#31-retention-joins)
- [32. Funnel Joins](#32-funnel-joins)
- [33. Source-Target Reconciliation Join](#33-source-target-reconciliation-join)
- [34. Joining to Calendar Tables](#34-joining-to-calendar-tables)
- [35. Joining Expected vs Actual Sets](#35-joining-expected-vs-actual-sets)
- [36. As-Of Join to Slowly Changing Dimension](#36-as-of-join-to-slowly-changing-dimension)
- [37. Detect SCD Join Problems](#37-detect-scd-join-problems)
- [38. Self Join](#38-self-join)
- [39. Joining Consecutive Rows with LAG Instead of Self Join](#39-joining-consecutive-rows-with-lag-instead-of-self-join)
- [40. Non-Equi Joins](#40-non-equi-joins)
- [41. Join Events to Sessions](#41-join-events-to-sessions)
- [42. Joining Exchange Rates](#42-joining-exchange-rates)
- [43. Join with Pre-Aggregated Metrics](#43-join-with-pre-aggregated-metrics)
- [44. Join for Campaign ROI](#44-join-for-campaign-roi)
- [45. Join for Product Attach Rate](#45-join-for-product-attach-rate)
- [46. Join for Product Category Revenue Share](#46-join-for-product-category-revenue-share)
- [47. Join for Orders Without Payments](#47-join-for-orders-without-payments)
- [48. Join for Products Never Sold](#48-join-for-products-never-sold)
- [49. Join for Latest Record from History](#49-join-for-latest-record-from-history)
- [50. Join for Current Snapshot from SCD](#50-join-for-current-snapshot-from-scd)
- [51. Join for As-Of Price](#51-join-for-as-of-price)
- [52. Join with Date Ranges](#52-join-with-date-ranges)
- [53. Join with Bridge Table](#53-join-with-bridge-table)
- [54. Join for Experiment Analysis](#54-join-for-experiment-analysis)
- [55. Join for First-Touch Attribution](#55-join-for-first-touch-attribution)
- [56. Join for Last-Touch Attribution](#56-join-for-last-touch-attribution)
- [57. Join for Nearest Prior Record](#57-join-for-nearest-prior-record)
- [58. Join for Latest Event After Trigger](#58-join-for-latest-event-after-trigger)
- [59. Join for Duplicate Detection Across Tables](#59-join-for-duplicate-detection-across-tables)
- [60. Join for Data Quality Summary](#60-join-for-data-quality-summary)
- [61. Join Performance Basics](#61-join-performance-basics)
- [62. Broadcast vs Shuffle Join Concept](#62-broadcast-vs-shuffle-join-concept)
- [63. Join Key Data Type Mismatch](#63-join-key-data-type-mismatch)
- [64. Join Key Normalization](#64-join-key-normalization)
- [65. Join with Duplicate Natural Keys](#65-join-with-duplicate-natural-keys)
- [66. Join for Slowly Changing Dimension Current vs Historical](#66-join-for-slowly-changing-dimension-current-vs-historical)
- [67. Join for Snapshot Tables](#67-join-for-snapshot-tables)
- [68. Join for Daily Active Users by Country](#68-join-for-daily-active-users-by-country)
- [69. Join for Monthly Active Users by Plan](#69-join-for-monthly-active-users-by-plan)
- [70. Join with Aggregated Dimension Attributes](#70-join-with-aggregated-dimension-attributes)
- [71. Join with Window Deduped Dimension](#71-join-with-window-deduped-dimension)
- [72. Join Debugging Checklist](#72-join-debugging-checklist)
- [73. Join Validation Queries](#73-join-validation-queries)
- [74. Join Edge Cases](#74-join-edge-cases)
- [75. Common Join Mistakes](#75-common-join-mistakes)
- [76. Pattern Classification Drill](#76-pattern-classification-drill)
- [77. High-ROI Join Topics](#77-high-roi-join-topics)
- [78. 7-Day Joins Plan](#78-7-day-joins-plan)
- [79. 30-Day Joins Plan](#79-30-day-joins-plan)
- [80. Mock Set 1: Join Fundamentals](#80-mock-set-1-join-fundamentals)
- [81. Mock Set 2: Cardinality and Double Counting](#81-mock-set-2-cardinality-and-double-counting)
- [82. Mock Set 3: Semi/Anti/Reconciliation Joins](#82-mock-set-3-semiantireconciliation-joins)
- [83. Mock Set 4: Advanced DE Joins](#83-mock-set-4-advanced-de-joins)
...
- [97. SQL Joins FAQ](#97-sql-joins-faq)
- [98. Additional Join Scenario Cards](#98-additional-join-scenario-cards)
<!-- END SECTION INDEX -->
