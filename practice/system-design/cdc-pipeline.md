...
- [3. CDC Mental Model](#3-cdc-mental-model)
- [4. CDC Vocabulary](#4-cdc-vocabulary)
- [5. Standard CDC Answer Framework](#5-standard-cdc-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Requirement Clarification Questions](#7-requirement-clarification-questions)
- [8. CDC Requirements](#8-cdc-requirements)
- [9. Reference CDC Architecture](#9-reference-cdc-architecture)
- [10. CDC Method Decision](#10-cdc-method-decision)
- [11. Full Refresh vs Incremental vs CDC](#11-full-refresh-vs-incremental-vs-cdc)
- [12. Source Database Log Concepts](#12-source-database-log-concepts)
- [13. Initial Snapshot](#13-initial-snapshot)
- [14. Snapshot Plus CDC Catch-Up](#14-snapshot-plus-cdc-catch-up)
- [15. CDC Event Schema](#15-cdc-event-schema)
- [16. Operation Types](#16-operation-types)
- [17. Offset and Checkpoint Strategy](#17-offset-and-checkpoint-strategy)
- [18. Ordering Strategy](#18-ordering-strategy)
- [19. Raw CDC Landing](#19-raw-cdc-landing)
- [20. CDC Staging Layer](#20-cdc-staging-layer)
- [21. Current-State Table Design](#21-current-state-table-design)
- [22. History Table / SCD Type 2 Design](#22-history-table-scd-type-2-design)
- [23. Deduplication of CDC Events](#23-deduplication-of-cdc-events)
- [24. Latest Event Per Key for Current State](#24-latest-event-per-key-for-current-state)
- [25. Out-of-Order Events](#25-out-of-order-events)
- [26. Delete Handling](#26-delete-handling)
- [27. Tombstone Events](#27-tombstone-events)
- [28. Idempotent CDC Sink](#28-idempotent-cdc-sink)
- [29. Checkpoint Commit Discipline](#29-checkpoint-commit-discipline)
- [30. Raw Replay Strategy](#30-raw-replay-strategy)
- [31. Data Quality Checks for CDC](#31-data-quality-checks-for-cdc)
- [32. Source-Target Reconciliation](#32-source-target-reconciliation)
- [33. CDC Lag Monitoring](#33-cdc-lag-monitoring)
- [34. Operational Metrics](#34-operational-metrics)
- [35. Alert Conditions](#35-alert-conditions)
- [36. Failure Handling](#36-failure-handling)
- [37. Schema Evolution](#37-schema-evolution)
- [38. Data Contracts for CDC](#38-data-contracts-for-cdc)
- [39. Security and Governance](#39-security-and-governance)
- [40. Cost and Scaling](#40-cost-and-scaling)
- [41. Practice Case 1: OLTP Orders CDC to Warehouse](#41-practice-case-1-oltp-orders-cdc-to-warehouse)
- [42. Practice Case 2: Payments CDC with Finance Reconciliation](#42-practice-case-2-payments-cdc-with-finance-reconciliation)
- [43. Practice Case 3: User Profile CDC to SCD Type 2](#43-practice-case-3-user-profile-cdc-to-scd-type-2)
- [44. Practice Case 4: Inventory CDC](#44-practice-case-4-inventory-cdc)
- [45. Practice Case 5: CDC into Data Lake](#45-practice-case-5-cdc-into-data-lake)
- [46. Practice Case 6: Kafka Debezium CDC](#46-practice-case-6-kafka-debezium-cdc)
- [47. Practice Case 7: Micro-Batch CDC to Snowflake/BigQuery](#47-practice-case-7-micro-batch-cdc-to-snowflakebigquery)
- [48. Practice Case 8: Multi-Table CDC Pipeline](#48-practice-case-8-multi-table-cdc-pipeline)
- [49. Practice Case 9: CDC Backfill / Re-Snapshot](#49-practice-case-9-cdc-backfill-re-snapshot)
- [50. Practice Case 10: CDC Schema Change Event](#50-practice-case-10-cdc-schema-change-event)
- [51. Initial Snapshot Consistency](#51-initial-snapshot-consistency)
- [52. Incremental Snapshotting](#52-incremental-snapshotting)
- [53. Transaction Boundaries](#53-transaction-boundaries)
- [54. Multi-Table Dependencies](#54-multi-table-dependencies)
- [55. High-Volume CDC](#55-high-volume-cdc)
- [56. Hot Keys and Update Storms](#56-hot-keys-and-update-storms)
- [57. Warehouse Merge Optimization](#57-warehouse-merge-optimization)
- [58. Lakehouse CDC Tables](#58-lakehouse-cdc-tables)
- [59. CDC Replay and Disaster Recovery](#59-cdc-replay-and-disaster-recovery)
- [60. Source Log Retention Risk](#60-source-log-retention-risk)
- [61. Privacy and Deletes](#61-privacy-and-deletes)
- [62. CDC vs Event Sourcing](#62-cdc-vs-event-sourcing)
- [63. Pattern Classification Drill](#63-pattern-classification-drill)
- [64. High-ROI CDC Topics](#64-high-roi-cdc-topics)
- [65. Review Checklist](#65-review-checklist)
- [66. Weakness Repair Map](#66-weakness-repair-map)
- [67. 7-Day CDC Study Plan](#67-7-day-cdc-study-plan)
- [68. 30-Day CDC Study Plan](#68-30-day-cdc-study-plan)
- [69. Timed Interview Protocol](#69-timed-interview-protocol)
- [70. CDC Whiteboard Template](#70-cdc-whiteboard-template)
- [71. CDC Event Schema Template](#71-cdc-event-schema-template)
- [72. CDC Current Table Template](#72-cdc-current-table-template)
- [73. CDC History Table Template](#73-cdc-history-table-template)
- [74. CDC DQ Checklist Template](#74-cdc-dq-checklist-template)
- [75. CDC Failure Runbook Template](#75-cdc-failure-runbook-template)
- [76. Mock Set 1: CDC Foundations](#76-mock-set-1-cdc-foundations)
- [77. Mock Set 2: Current-State Loading](#77-mock-set-2-current-state-loading)
- [78. Mock Set 3: History and SCD](#78-mock-set-3-history-and-scd)
- [79. Mock Set 4: Operations and Recovery](#79-mock-set-4-operations-and-recovery)
- [80. Mock Set 5: Case Designs](#80-mock-set-5-case-designs)
- [81. CDC FAQ](#81-cdc-faq)
- [82. Candidate Self-Review Questions](#82-candidate-self-review-questions)
- [83. Final Exit Test](#83-final-exit-test)
- [84. Final Summary](#84-final-summary)
- [85. Additional Mini Scenario Cards](#85-additional-mini-scenario-cards)
