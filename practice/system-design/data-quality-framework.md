...
- [4. Data Quality Vocabulary](#4-data-quality-vocabulary)
- [5. Standard DQ Framework Answer Framework](#5-standard-dq-framework-answer-framework)
...
- [9. Reference Data Quality Architecture](#9-reference-data-quality-architecture)
- [10. Where DQ Checks Run](#10-where-dq-checks-run)
- [11. Rule Configuration Design](#11-rule-configuration-design)
- [12. DQ Rule Config Table](#12-dq-rule-config-table)
- [13. DQ Result Table](#13-dq-result-table)
- [14. DQ Rule Types](#14-dq-rule-types)
- [15. Severity Model](#15-severity-model)
- [16. Quality Gate Behavior](#16-quality-gate-behavior)
- [17. Hard Checks vs Soft Checks](#17-hard-checks-vs-soft-checks)
- [18. Threshold Design](#18-threshold-design)
- [19. Ownership Model](#19-ownership-model)
- [20. Rule Lifecycle](#20-rule-lifecycle)
- [21. Freshness Checks](#21-freshness-checks)
- [22. Completeness Checks](#22-completeness-checks)
- [23. Uniqueness Checks](#23-uniqueness-checks)
- [24. Null Checks](#24-null-checks)
- [25. Validity Checks](#25-validity-checks)
- [26. Referential Integrity Checks](#26-referential-integrity-checks)
- [27. Consistency Checks](#27-consistency-checks)
- [28. Reconciliation Checks](#28-reconciliation-checks)
- [29. Schema Checks](#29-schema-checks)
- [30. Volume Checks](#30-volume-checks)
- [31. Anomaly Detection Checks](#31-anomaly-detection-checks)
- [32. Accuracy Checks](#32-accuracy-checks)
- [33. Timeliness Checks](#33-timeliness-checks)
- [34. Distribution Checks](#34-distribution-checks)
- [35. Business Rule Checks](#35-business-rule-checks)
- [36. DQ Execution Engine](#36-dq-execution-engine)
- [37. DQ Result Storage](#37-dq-result-storage)
- [38. Failure Sample Storage](#38-failure-sample-storage)
- [39. Quarantine Design](#39-quarantine-design)
- [40. Pipeline Integration](#40-pipeline-integration)
- [41. Alerting Design](#41-alerting-design)
- [42. DQ Dashboard Design](#42-dq-dashboard-design)
- [43. Quality Score](#43-quality-score)
- [44. Remediation Workflow](#44-remediation-workflow)
- [45. False Positive Management](#45-false-positive-management)
- [46. Batch Pipeline DQ](#46-batch-pipeline-dq)
- [47. Streaming DQ](#47-streaming-dq)
- [48. CDC DQ](#48-cdc-dq)
- [49. Data Lake DQ](#49-data-lake-dq)
- [50. Warehouse DQ](#50-warehouse-dq)
- [51. ML Feature DQ](#51-ml-feature-dq)
- [52. Finance DQ](#52-finance-dq)
- [53. API Ingestion DQ](#53-api-ingestion-dq)
- [54. File Ingestion DQ](#54-file-ingestion-dq)
- [55. Dashboard DQ](#55-dashboard-dq)
- [56. Practice Case 1: Daily Sales Mart DQ Framework](#56-practice-case-1-daily-sales-mart-dq-framework)
- [57. Practice Case 2: CDC Orders DQ Framework](#57-practice-case-2-cdc-orders-dq-framework)
- [58. Practice Case 3: Data Lake DQ Framework](#58-practice-case-3-data-lake-dq-framework)
- [59. Practice Case 4: Partner File DQ Framework](#59-practice-case-4-partner-file-dq-framework)
- [60. Practice Case 5: Finance Reconciliation DQ Framework](#60-practice-case-5-finance-reconciliation-dq-framework)
- [61. Practice Case 6: ML Feature DQ Framework](#61-practice-case-6-ml-feature-dq-framework)
- [62. Practice Case 7: Streaming Event DQ Framework](#62-practice-case-7-streaming-event-dq-framework)
- [63. Practice Case 8: Customer 360 DQ Framework](#63-practice-case-8-customer-360-dq-framework)
- [64. Practice Case 9: SCD Dimension DQ Framework](#64-practice-case-9-scd-dimension-dq-framework)
- [65. Practice Case 10: DQ Platform for Enterprise](#65-practice-case-10-dq-platform-for-enterprise)
- [66. Data Observability vs Data Quality](#66-data-observability-vs-data-quality)
- [67. Data Contracts and DQ](#67-data-contracts-and-dq)
- [68. Cost-Aware DQ Execution](#68-cost-aware-dq-execution)
- [69. DQ for Large Tables](#69-dq-for-large-tables)
- [70. DQ for Late-Arriving Data](#70-dq-for-late-arriving-data)
- [71. DQ and Certification](#71-dq-and-certification)
- [72. DQ Incident Management](#72-dq-incident-management)
- [73. DQ Framework Trade-Offs](#73-dq-framework-trade-offs)
- [74. DQ Anti-Patterns](#74-dq-anti-patterns)
- [75. Rollout Strategy](#75-rollout-strategy)
- [76. Pattern Classification Drill](#76-pattern-classification-drill)
- [77. High-ROI DQ Topics](#77-high-roi-dq-topics)
- [78. Review Checklist](#78-review-checklist)
- [79. Weakness Repair Map](#79-weakness-repair-map)
- [80. 7-Day DQ Framework Study Plan](#80-7-day-dq-framework-study-plan)
- [81. 30-Day DQ Framework Study Plan](#81-30-day-dq-framework-study-plan)
- [82. Timed Interview Protocol](#82-timed-interview-protocol)
- [83. DQ Framework Whiteboard Template](#83-dq-framework-whiteboard-template)
- [84. DQ Rule Template](#84-dq-rule-template)
- [85. DQ Result Template](#85-dq-result-template)
- [86. DQ Alert Template](#86-dq-alert-template)
- [87. Quarantine Template](#87-quarantine-template)
- [88. Mock Set 1: DQ Framework Foundation](#88-mock-set-1-dq-framework-foundation)
- [89. Mock Set 2: Core Checks](#89-mock-set-2-core-checks)
- [90. Mock Set 3: Advanced Checks](#90-mock-set-3-advanced-checks)
- [91. Mock Set 4: Operations](#91-mock-set-4-operations)
- [92. Mock Set 5: Case Designs](#92-mock-set-5-case-designs)
- [93. Data Quality FAQ](#93-data-quality-faq)
- [94. Candidate Self-Review Questions](#94-candidate-self-review-questions)
- [95. Final Exit Test](#95-final-exit-test)
- [96. Final Summary](#96-final-summary)
- [97. Additional Mini Scenario Cards](#97-additional-mini-scenario-cards)
