...
- [4. Realtime Pipeline Vocabulary](#4-realtime-pipeline-vocabulary)
- [5. Standard Realtime Pipeline Answer Framework](#5-standard-realtime-pipeline-answer-framework)
- [6. Scoring Rubric](#6-scoring-rubric)
- [7. Requirement Clarification Questions](#7-requirement-clarification-questions)
- [8. Realtime vs Streaming vs Batch](#8-realtime-vs-streaming-vs-batch)
- [9. Reference Realtime Pipeline Architecture](#9-reference-realtime-pipeline-architecture)
- [10. Latency Budget](#10-latency-budget)
- [11. Producer Design](#11-producer-design)
- [12. Collection Layer](#12-collection-layer)
- [13. Event Schema](#13-event-schema)
- [14. Broker Design](#14-broker-design)
- [15. Topic Design](#15-topic-design)
- [16. Partitioning Strategy](#16-partitioning-strategy)
- [17. Consumer Groups](#17-consumer-groups)
- [18. Stream Processor](#18-stream-processor)
- [19. State Store](#19-state-store)
- [20. Checkpointing](#20-checkpointing)
- [21. Event Time, Processing Time, and Ingestion Time](#21-event-time-processing-time-and-ingestion-time)
- [22. Windowing](#22-windowing)
- [23. Watermarks](#23-watermarks)
- [24. Late Events](#24-late-events)
- [25. Out-of-Order Events](#25-out-of-order-events)
- [26. Deduplication](#26-deduplication)
- [27. Stateful Aggregation](#27-stateful-aggregation)
- [28. Stream Joins](#28-stream-joins)
- [29. Enrichment](#29-enrichment)
- [30. Realtime Feature Computation](#30-realtime-feature-computation)
- [31. Realtime Alerting](#31-realtime-alerting)
- [32. Idempotent Sinks](#32-idempotent-sinks)
- [33. Exactly-Once-Like Output](#33-exactly-once-like-output)
- [34. Dead-Letter Queue](#34-dead-letter-queue)
- [35. Replay and Backfill](#35-replay-and-backfill)
- [36. Data Quality Checks](#36-data-quality-checks)
- [37. Monitoring Metrics](#37-monitoring-metrics)
- [38. Alert Conditions](#38-alert-conditions)
- [39. Backpressure Handling](#39-backpressure-handling)
- [40. Scaling Strategy](#40-scaling-strategy)
- [41. Hot Partition Handling](#41-hot-partition-handling)
- [42. State Management](#42-state-management)
- [43. Serving Sink Options](#43-serving-sink-options)
- [44. Security and Privacy](#44-security-and-privacy)
- [45. Cost Controls](#45-cost-controls)
- [46. Practice Case 1: Realtime Clickstream Dashboard](#46-practice-case-1-realtime-clickstream-dashboard)
- [47. Practice Case 2: Realtime Fraud Detection Pipeline](#47-practice-case-2-realtime-fraud-detection-pipeline)
- [48. Practice Case 3: Realtime Error Monitoring Pipeline](#48-practice-case-3-realtime-error-monitoring-pipeline)
- [49. Practice Case 4: Realtime IoT Telemetry Pipeline](#49-practice-case-4-realtime-iot-telemetry-pipeline)
- [50. Practice Case 5: Realtime Inventory Pipeline](#50-practice-case-5-realtime-inventory-pipeline)
- [51. Practice Case 6: Realtime CDC Pipeline](#51-practice-case-6-realtime-cdc-pipeline)
- [52. Practice Case 7: Realtime ML Feature Pipeline](#52-practice-case-7-realtime-ml-feature-pipeline)
- [53. Practice Case 8: Realtime Recommendation Signals](#53-practice-case-8-realtime-recommendation-signals)
- [54. Practice Case 9: Realtime Payment Monitoring](#54-practice-case-9-realtime-payment-monitoring)
- [55. Practice Case 10: Realtime Security Event Pipeline](#55-practice-case-10-realtime-security-event-pipeline)
- [56. Fast Path + Correct Path](#56-fast-path-correct-path)
- [57. Realtime vs Request-Time Computation](#57-realtime-vs-request-time-computation)
- [58. External API Calls in Stream Jobs](#58-external-api-calls-in-stream-jobs)
- [59. Stateful Join With Changing Dimensions](#59-stateful-join-with-changing-dimensions)
- [60. Realtime Corrections](#60-realtime-corrections)
- [61. Multi-Region Realtime Pipelines](#61-multi-region-realtime-pipelines)
- [62. Disaster Recovery](#62-disaster-recovery)
- [63. Stateful Processing Failure Modes](#63-stateful-processing-failure-modes)
- [64. Realtime Data Quality vs Batch DQ](#64-realtime-data-quality-vs-batch-dq)
- [65. Realtime Pipeline Anti-Patterns](#65-realtime-pipeline-anti-patterns)
- [66. Realtime Pipeline Trade-Offs](#66-realtime-pipeline-trade-offs)
- [67. Pattern Classification Drill](#67-pattern-classification-drill)
- [68. High-ROI Realtime Topics](#68-high-roi-realtime-topics)
- [69. Review Checklist](#69-review-checklist)
- [70. Weakness Repair Map](#70-weakness-repair-map)
- [71. 7-Day Realtime Pipeline Study Plan](#71-7-day-realtime-pipeline-study-plan)
- [72. 30-Day Realtime Pipeline Study Plan](#72-30-day-realtime-pipeline-study-plan)
- [73. Timed Interview Protocol](#73-timed-interview-protocol)
- [74. Realtime Pipeline Whiteboard Template](#74-realtime-pipeline-whiteboard-template)
- [75. Realtime Event Schema Template](#75-realtime-event-schema-template)
- [76. Stream Processing Design Template](#76-stream-processing-design-template)
- [77. Realtime DQ Checklist Template](#77-realtime-dq-checklist-template)
- [78. Realtime Incident Runbook Template](#78-realtime-incident-runbook-template)
- [79. Mock Set 1: Realtime Foundations](#79-mock-set-1-realtime-foundations)
- [80. Mock Set 2: Correctness](#80-mock-set-2-correctness)
- [81. Mock Set 3: Stateful Processing](#81-mock-set-3-stateful-processing)
- [82. Mock Set 4: Operations](#82-mock-set-4-operations)
- [83. Mock Set 5: Case Designs](#83-mock-set-5-case-designs)
- [84. Realtime Pipeline FAQ](#84-realtime-pipeline-faq)
